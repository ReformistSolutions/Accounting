...
public class EstimatePdf extends AbstractPdfView{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		final String path = System.getProperty("user.dir");  
		 PdfWriter.getInstance(doc, new FileOutputStream(path+"/Sales Estimate.pdf"));      
	        doc.open();
		/*salesEstimate*/
		Estimate salesEstimate=(Estimate) model.get("salesEstimate");
		...
		tableHD.setSpacingBefore(10);
			...
			//cell3.setPadding(5);
			cell3.setPhrase(new Phrase("SALES  ESTIMATE",font1));			
			//cell3.setColspan(5);
    ...
    celld1 = new PdfPCell(new Phrase("Customer Name      : "+"   "+salesEstimate.getTxtCutName(),font));
    celld1.setColspan(3);
    tabled.addCell(celld1);
    
    celld2 = new PdfPCell(new Phrase("Billing Address       : "+"   "+salesEstimate.getTxtBillAddr(),font));
    celld2.setColspan(3);
    tabled.addCell(celld2);		        
    
    celld3 = new PdfPCell(new Phrase("Shipping Address    : "+"   "+salesEstimate.getTxtShipAddr(),font));
    celld3.setColspan(3);
    tabled.addCell(celld3);		
    
    celld4 = new PdfPCell(new Phrase("Party VAT TIN No : "+"   "+salesEstimate.getCustVatNo(),font));
    celld4.setColspan(3);
   ...
   /* celld11 = new PdfPCell(new Phrase("Invoice No :-"+"       "+salesEstimate.getTxtInvID(),font));
    celld11.setColspan(3);
    tabledd.addCell(celld11);*/
    
    celld12 = new PdfPCell(new Phrase("Estimate No    : "+"      "+salesEstimate.getTxtEstID(),font));
    celld12.setColspan(3);
    tabledd.addCell(celld12);
     
   /* celld12 = new PdfPCell(new Phrase("P.O. No      : "+"      "+salesEstimate.getTxtCPONo(),font));
    celld12.setColspan(3);
    tabledd.addCell(celld12);
    */
    celld13 = new PdfPCell(new Phrase("Date                : "+"      "+salesEstimate.getTxtDate(),font));
    celld13.setColspan(3);
    tabledd.addCell(celld13);		
    
    /*celld14 = new PdfPCell(new Phrase("Due Date    : "+"      "+salesEstimate.getTxtDueDate(),font));
  ...
  */
	...
	doc.add(tableBlf1);
		...
		ordProductList.addAll(salesEstimate.getProductList());
		//int flag=0;
		...
		estTaxList.addAll(salesEstimate.getTaxList());		
		...
		estLinkedTaxList.addAll(salesEstimate.getLinkedTaxList());	
        ...
        PdfPCell celln = new PdfPCell(new Phrase("Notes :\n\n"+"\t"+salesEstimate.getTxtpubNotes()));	     
       // celln.setRowspan(9);		      
        table.addCell(celln);
       /* table.addCell(new Phrase("Sub Total",font));
        PdfPCell stCell=new PdfPCell(new Phrase(Convert.toString(salesEstimate.getTxtSubTotal()),font));
        stCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
        table.addCell(stCell);
       // table.addCell(new Phrase());
        table.addCell(new Phrase("Discount",font));
        String rd=Convert.toString(salesEstimate.getRadio());
        if(rd.equals("per")){
	        PdfPCell vtCell=new PdfPCell(new Phrase("@"+salesEstimate.getTxtDiscount() +"%",font));			       
	        vtCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	        table.addCell(vtCell);
        }
        else
        {
        	PdfPCell vtCell=new PdfPCell(new Phrase(Convert.toString(salesEstimate.getTxtDiscount()),font));			       
	        vtCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	        table.addCell(vtCell);
        }*/
      ...
      /*
       ...
       /* table.addCell(new Phrase("Discounted Total",font));	
        PdfPCell disCell =new PdfPCell(new Phrase(Convert.toString(salesEstimate.getTxtDisTotal()),font));
       ...
       /* PdfPCell taxCell =new PdfPCell();			        
        ...
        PdfPCell gtCell =new PdfPCell(new Phrase(Convert.toString(salesEstimate.getTxtAmtPayble()),font));
