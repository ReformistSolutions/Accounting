...
public class RecordWastagePDF extends AbstractPdfView {
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		RecordWastage recordWastage=(RecordWastage) model.get("recordWastageview");
		doc.open();
		...
		cell3.setPhrase(new Phrase("RECORD WASTAGE",font1));
		...
		f1.setColor(BaseColor.BLACK);
		    ...
		    celld1 = new PdfPCell(new Phrase("Voucher No      :"+"   "+recordWastage.getTxtVNo(),f1));
		    celld1.setColspan(3);	    
		    tabled.addCell(celld1);
		    
		    celld2 = new PdfPCell(new Phrase("Date  :"+"   "+recordWastage.getDate(),f1));
		    celld2.setColspan(3);
		    ...
		    celld11 = new PdfPCell(new Phrase("Warehouse Name :"+"       "+recordWastage.getSelectWarehouse(),f1));
			...
			List<RecordWastageDetails> recordWastageDetailsDetails=new ArrayList<RecordWastageDetails>();		
			recordWastageDetailsDetails.addAll(recordWastage.getRecordWastageDetailsList());
			for(RecordWastageDetails issueproductList : recordWastageDetailsDetails)
			{
		...
		cell.setPhrase(new Phrase(recordWastage.getTxtDetails(),font));
		cell.setBorder(Rectangle.NO_BORDER);
