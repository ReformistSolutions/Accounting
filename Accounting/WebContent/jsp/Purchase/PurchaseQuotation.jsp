...
xmlhttp.open("GET","retriveTaxID.do?taxName="+tax,true);
xmlhttp.send();
...
<%@ include file="../header.jsp" %> 
	...
	<input type="hidden" name="hide" id="hidden" />
		...
		<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li class="active"><small><i class="fa fa-2x fa-table"></i></small>&nbsp;Purchase<small>&nbsp;Quotation</small>
			             	...
			             	<div class="col-md-2"> 
			             	<!-- <a href="#" class="btn btn-primary btn-large" onclick="backPage()"> Back</a> -->
		...
		<br>
	<form:form action="addPurchaseQuotation.do" onsubmit="return validateForm()" cssClass="form-inline" name="frmPurchaseQuotation" modelAttribute="purchaseQuotation">
		...
		<div class=col-md-12>
							...
							<core:if test="${message==0}">                     
								<h4 class="msg-error">
								Quotation Not Added Succesfully.
								</h4> 
							</core:if>
							</div>
		<div class="col-md-12">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">		
					<form:select path="txtCustName" cssClass="form-control" onchange="showAdd(this.value,this.id)"> 				
					...
					<!-- <div class="col-md-2"></div><a href=""><button type="submit" class="btn btn-primary">ADD</button></a> -->					
				</div>
			...
			<div class="col-md-6  pull right">
					...
					<div class="col-md-4">
					<input type="text" name="txyQuotationNo" class="form-control" readonly="readonly" style="width: 100px;" value="${quotationId.txyQuotationNo}"/>
					</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">		
					<input type="text" name="txtQuotationDate" id="dp1" value="<%=dt %>" class="form-control" >
					</div>
				</div>
			</div>			
		</div><br>
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">					 
					<form:textarea rows="2" cols="25" cssClass="form-control" cssStyle="resize : none;" path="txtBillingTo" onkeyup="textAreaAdjust(this)" style="overflow:hidden"></form:textarea>
					</div>
				</div>
			</div>
			<div class="col-md-6">
			<div class="row">
					...
					<%-- <form:label cssClass="col-md" cssStyle="vertical-align: top;" path=""> --%>
		      			...
		      			<%-- </form:label> --%> 		      			      					
					<form:textarea rows="2" cols="25" cssClass="form-control" cssStyle="resize : none;" path="txtAreaShipto" onkeyup="textAreaAdjust(this)" style="overflow:hidden"></form:textarea>
			</div>
		</div>
		</div>
		<br>
		<div class="table-responsive">
						<table id="tableID" class="table table-striped">		
								...
								<tr>
									...
									<td><!-- estimateList -->
            						<select name="productList[0].itemCode" id="itemCode0" class="form-control" style="width:100px" onchange="showDesc(this.value,this.id);showUnitPrice(this.value,this.id);disQuantity(this.id);">
									...
									<td><input readonly="readonly" type="text" name="productList[0].unit" id="productList[0].unit" class="form-control" style="width:80px;"></td>
...
<option value="---Select---">---Select---</option>
<core:forEach items="${taxList}" var="taxList1">
