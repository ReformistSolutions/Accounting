...
<form:form action="updateDebitNotes.do" modelAttribute="editdebittnote" cssClass="form-inline" name="frmAC">
<div class="col-md-12">
       ...
       <div class="panel-body">       
                        <div class="col-sm-6">	     
                   		...
                   		<div>  
                            ...
                            <div>  
                            <input type="date" name="txtTransactionDate" class="form-control" value="${editdebittnote.txtTransactionDate}"style="width: 180px;">
                            ...
                            <div>                            
                            	...
                            	<form:select path="txtFromAcnt" id="txtFA" cssClass="form-control" cssStyle="width: 150px;">
                            		<option value="${editdebittnote.frmAccno}">${editdebittnote.txtFromAcnt}</option>
                            		
                                  	<option>-----SELECT-----</option>
                                  	
                            		<c:forEach items="${editList}" var="editList">
                            		<option value="${editList.txtNewAccNo}">${editList.txtAccountName}</option>
                          ...
                          <div>                            
                            	<%-- <input type="text" name="txtTooAcnt" value="${editdebittnote.toAccno}"> --%>
                            	<form:select path="txtToAcnt" id="txtTA" cssClass="form-control" cssStyle="width: 150px;">
                            		<option value="${editdebittnote.toAccno}">${editdebittnote.txtToAcnt}</option>
                            ...
                            <div>                            
                            	<textarea name="txtDescription" rows="4" cols="50" id="txtDes" class="form-control">${editdebittnote.txtDescription}</textarea>
