...
<%@ include file="../header.jsp" %>
	...
	<input type="hidden" id="hide" name="hide1"> 
		...
		<br>
			<form:form action="updatePurchaseOrder.do" onsubmit="return validateForm()" name="frmPurchaseOrder"  cssClass="form-inline"  modelAttribute="editorder">
		<div class="col-md-12">
		<div class="panel panel-default">
		<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<form:select path="selSupplierName" cssClass="form-control">  
							<option>${editorder.selSupplierName}</option>
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">   
					<form:input path="txtPurchaseOrdNo" cssClass="form-control" readonly="true" cssStyle="width:100px"></form:input>
					</div>
				</div>		 
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
						<input type="text" id="dp1" name="txtPurcaseDate" class="form-control" value="${editorder.txtPurcaseDate}"/>
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
						<input type="text" id="dp2" name="txtDueDate" class="form-control" value="${editorder.txtDueDate}"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="table-responsive" style="width: 90%;"> 	
			<table class="table table-striped" id="tableID">
				...
				<tbody>
				<c:forEach items="${editorder.productList}" var="pList">
					<tr>
						...
						<td>
            						<select name="productList[${pList.srNo-1}].itemCode" id="itemCode${pList.srNo-1}" class="form-control"  onchange="showDesc(this.value,this.id);showUnitPrice(this.value,this.id);">
											...
											<option value="${pList.prodId}" id="${pList.prodId}">${pList.itemCode}</option>										
												...
												<c:forEach items="${pOrderList}" var="pOrderList">
						...
						<td><form:input path="productList[${pList.srNo-1}].des" id="productList[${pList.srNo-1}].des" cssClass="form-control"  ></form:input></td>
						<td><form:input path="productList[${pList.srNo-1}].unit" readonly="true" id="productList[${pList.srNo-1}].unit" cssClass="form-control" cssStyle="width:80px;" ></form:input></td>
		...
		<div class="first-column">
			...
			<div class="col-md-7">
				...
				<div class="col-md-12">
					...
					<div class="col-md-5">
						<input type="text" name="txtSubTotal" readonly="readonly" id="txtSubTotal" class="form-control" value="${ editorder.txtSubTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div> 
				...
				<div class="col-md-12">
					<div class="col-md-3">
						<div class="row">
						<c:choose>
						<c:when test="${ editorder.radio=='per'}">
					...
					<div class="col-md-5">
						<input type="text" name="txtDiscount" id="txtDiscount" value="${ editorder.txtDiscount}" class="form-control" onkeypress="return isNumberKey(this)" onblur="calDis();"></input>
					</div>					
					<br>
				</div>				
				</div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="text" name="txtDisTotal" readonly="readonly" id="txtDisTotal" class="form-control" value="${ editorder.txtDisTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>	
				<c:choose>
...
<tbody>
<%int cnt=1; %>
<c:forEach items="${editorder.taxList}" var="taxDetailsList">
<tr>
<td>
...
<div id="linkedDiv">
<%int count=1; %>
	<c:forEach items="${editorder.linkedTaxList}" var="linkedTaxList">
		<div>
...
<tr><td colspan="5" id="getTax1"></td></tr>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="hidden" name="txtTaxTotal" value="${editorder.txtTaxTotal}" id="txtTaxTotal" class="form-control"/>
						<input type="text" name="txtRoundOff" value="${editorder.txtRoundOff}" readonly="readonly" id="txtRoundOff" class="form-control" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
				<div style="height: 5px;"></div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						...
						<input type="text" name="txtAmtPayble" readonly="readonly" id="txtAmtPayble" class="form-control" value="${editorder.txtAmtPayble}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
