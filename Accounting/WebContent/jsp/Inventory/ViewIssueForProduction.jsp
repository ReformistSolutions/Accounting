	...
	<input type="hidden" id="hide" name="hide1" value="0"> <br>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="col-md-10">
					<ul class="breadcrumb">
						 <li class="active"><small><i class="fa fa-2x fa-table"></i></small>&nbsp;View&nbsp;Issue&nbsp;For&nbsp;Production<small></small>
		         	</ul>
		         </div>
		         <div class="col-md-2">
...
<form:form action="" cssClass="form-inline" modelAttribute="issueForProductionView"  name="frmissueForProduction">
<div class="col-md-12">
<div class="panel panel-default">                       
                        <div class="panel-body">
								<div class="row">
								<div class="col-md-4">
									<div class="row">
										...
										<div class="col-md-4">  
											<label>${issueForProductionView.txtVNo}</label>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="row">
										...
										<div class="col-md-7">
											<label>${issueForProductionView.date}</label>
										</div>
									</div>
								</div>								
							</div><br>
							<div class="row">
								<div class="col-md-4">
									<div class="row">
										...
										<div class="col-md-4">  
											<label>${issueForProductionView.selectWarehouse}</label>
										</div>
									</div>
								</div>																
							</div><br>
								<div>				
									<div class="table-responsive" style="width: 50%;">	
						         				<table id="tableID" class="table table-striped">        					         					
						        					...
						        					<c:forEach items="${issueForProductionView.productList}" var="productList"> 					
						         					<tr>
						         			 ...
						         			 <div><label>Details:-</label></div><div><label>${issueForProductionView.txtDetails}</label></div><br>
											<div>
												 <input type="button" value="Print" name="btn" class="btn btn-primary" onclick="urlSubmit('issuePDF.do?txtVNo=${issueForProductionView.txtVNo}','_blank')">          
