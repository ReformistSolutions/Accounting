...
<%@ include file="../header.jsp" %>
	...
	<input type="hidden" id="hide" name="hide1"> 
		...
		<div class="col-md-12">
						...
						<div class="col-md-10">
						<ul class="breadcrumb">
							<li class="active"><small><i class="fa fa-2x fa-table"></i></small>&nbsp;Purchases<small>&nbsp;</small>
		             	</ul>
		             	</div>
			             	<div class="col-md-2">
		...
		<br>
			<form:form action="addPurchase.do" onsubmit="return validateForm()" name="frmPurchaseOrder"  cssClass="form-inline"  modelAttribute="purchases">
		<div class="col-md-12">
		<div class="panel">
		<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
					<input type="text" name="vendorName" value="${purchases.selSupplierName}" class="form-control" readonly="readonly">
					<input type="hidden" name="selSupplierName" value="${purchases.venderID}" readonly="readonly">
					<%-- <form:select path="selSupplierName" cssClass="form-control">  
							<option>${purchases.selSupplierName}</option>
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-4">
					<form:label path="txtPurchaseNo">Purchase&nbsp;No&nbsp;:</form:label>
					</div>				
					<div class="col-md-4">   
					<input type="text" name="txtPurchaseNo" class="form-control" value="${purchases.txtPurchaseNo}" readonly="readonly" style="width:100px"></input>
					<input type="hidden" name="selOrderID" value="${purchases.selOrderID}">  
					</div>
				</div>		 
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-4">
						<form:label path="txtPurchaseDate"> Date : </form:label>
					</div>
					<div class="col-md-4">
						<%
											...
											%> 
						<input type="text" id="dp1" name="txtPurchaseDate" class="form-control" value="<%=dt%>"/>
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
						<input type="text" id="dp2" name="txtDueDate" class="form-control" value="${purchases.txtDueDate}"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				...
				<div class="col-md-4">	
					<textarea name="txtAreaAddress" rows="2" cols="25" class="form-control" onkeyup="textAreaAdjust(this)" style="overflow:hidden">${ purchases.txtAreaAddress}</textarea>
				</div>
				</div>
			</div>			
		</div>
		...
		<div class="table-responsive" style="width: 90%;"> 	
			<table class="table table-striped" id="tableID">
				...
				<tbody>  
				<c:forEach items="${purchases.productList}" var="pList">
					<tr>
						...
						<td><input type="text" name="productList[0].unit" id="productList[0].unit" readonly="readonly" class="form-control" value="${pList.unit}" style="width:80px;"></td>
		...
		<div class="row">
					...
					<div class="panel-body">
                        ...
                        <div class="tab-content">
                        	<div class="tab-pane fade in active" id="home">
                        		<p></p> 
                        		<textarea name="txtPubNotes" readonly="readonly" class="form-control" cols="28" rows="5">${ purchases.txtPubNotes}</textarea>
                        	</div>
                        	<div class="tab-pane fade" id="profile">
                        		<p></p> 
                        		<textarea name="txtPvtNotes" class="form-control" cols="28" rows="5">${ purchases.txtPvtNotes}</textarea>
                        	</div>
                        </div>
					</div>
				</div>
			...
			<div class="col-md-7">
				...
				<div class="col-md-12">
					...
					<div class="col-md-5">
						<input type="text" name="txtSubTotal" readonly="readonly" id="txtSubTotal" class="form-control" value="${ purchases.txtSubTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div> 
				...
				<div class="col-md-12">
					...
					<div class="col-md-5">
						<input type="text" name="txtDiscount" id="txtDiscount" value="${ purchases.txtDiscount}" class="form-control" onkeypress="return isNumberKey(this)" onblur="calDis();"></input>
					</div>					
					<br>
				</div>				
				</div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="text" name="txtDisTotal" readonly="readonly" id="txtDisTotal" class="form-control" value="${ purchases.txtDisTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>	
				<c:choose>
...
<tbody>
<%int cnt=1; %>
<c:forEach items="${purchases.taxList}" var="taxDetailsList">
<tr>
<td>
<select name="taxList[<%=cnt%>].taxType" id="taxList[<%=cnt%>].taxType" style="width:170px;" class="form-control" onchange="showLinkedTax(this.value,this.id);"> 
...
<div id="linkedDiv">
<%int count=1; %>
	<c:forEach items="${purchases.linkedTaxList}" var="linkedTaxList">
		<div>
...
<tr><td colspan="5" id="getTax1"></td></tr>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="hidden" name="txtTaxTotal" value="${purchases.txtTaxTotal}" id="txtTaxTotal" class="form-control"/>
						<input type="text" name="txtRoundOff" value="${purchases.txtRoundOff}" readonly="readonly" id="txtRoundOff" class="form-control" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
				<div style="height: 5px;"></div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						...
						<input type="text" name="txtAmtPayble" readonly="readonly" id="txtAmtPayble" class="form-control" value="${purchases.txtAmtPayble}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
