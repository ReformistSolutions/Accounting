...
public class SalesInvoicePdf extends AbstractPdfView{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		PdfWriter.getInstance(doc, new FileOutputStream(System.getProperty("user.dir")+"/Sales Invoice.pdf"));      
	        doc.open();
		
	        doc.addTitle("Sales Invoice");
	        
		Invoice salesInvoice=(Invoice) model.get("salesInvoice");
		...
		tableHD.setSpacingBefore(10);
			...
			//cell3.setPadding(5);
			cell3.setPhrase(new Phrase("TAX   INVOICE",font1));			
			//cell3.setColspan(5);
	...
	Font fontn = FontFactory.getFont("Times-Roman",11,Font.UNDERLINE);
	fontn.setColor(BaseColor.BLACK);
    ...
    celld1 = new PdfPCell(new Phrase("Customer Name      :"+"   "+salesInvoice.getTxtCName(),font));
    celld1.setColspan(3);
    tabled.addCell(celld1);
    
    celld2 = new PdfPCell(new Phrase("Billing Address       :"+"   "+salesInvoice.getTxtBillAddr(),font));
    celld2.setColspan(3);
    tabled.addCell(celld2);		        
    
    celld3 = new PdfPCell(new Phrase("Shipping Address    :"+"   "+salesInvoice.getTxtShipAddr(),font));
    celld3.setColspan(3);
    tabled.addCell(celld3);		
    
    celld4 = new PdfPCell(new Phrase("Party VAT TIN No :"+"   "+salesInvoice.getCustVatNo(),font));
    celld4.setColspan(3);
   ...
   // doc.add(tabled);
    ...
    PdfPCell celld11,celld12,celld13,celld14;
    
    celld11 = new PdfPCell(new Phrase("Invoice No :"+"       "+salesInvoice.getTxtInvID(),font));
    celld11.setColspan(3);
    tabledd.addCell(celld11);
    
    celld12 = new PdfPCell(new Phrase("Order No    :"+"      "+salesInvoice.getOrderId(),font));
    celld12.setColspan(3);
    tabledd.addCell(celld12);
     
    celld12 = new PdfPCell(new Phrase("P.O. No      :"+"      "+salesInvoice.getTxtCPONo(),font));
    celld12.setColspan(3);
    tabledd.addCell(celld12);
    
    celld13 = new PdfPCell(new Phrase("Date            :"+"      "+salesInvoice.getTxtDate(),font));
    celld13.setColspan(3);
    tabledd.addCell(celld13);		
    
    celld14 = new PdfPCell(new Phrase("Due Date    :"+"      "+salesInvoice.getTxtDueDate(),font));
	...
	doc.add(tableBlf1);
		...
		ordProductList.addAll(salesInvoice.getProductList());
		//int flag=0;
		...
		List<TaxDetailsList> invTaxList=new ArrayList<TaxDetailsList>();		
		invTaxList.addAll(salesInvoice.getTaxList());		
		for(TaxDetailsList tList : invTaxList)
		{
			PdfPCell cell20 = new PdfPCell();
		...
		List<LinkedTaxDetails> invLinkedTaxList=new ArrayList<LinkedTaxDetails>();		
		invLinkedTaxList.addAll(salesInvoice.getLinkedTaxList());	
		for(LinkedTaxDetails lTList : invLinkedTaxList)
		{
			PdfPCell cell20 = new PdfPCell();
        ...
        PdfPCell stCell=new PdfPCell(new Phrase(Convert.toString(salesInvoice.getTxtSubTotal()),font));
       ...
       // table.addCell(new Phrase());
        ...
        String rd=Convert.toString(salesInvoice.getRadio());
        if(rd.equals("per"))
        {
        	/*PdfPCell celln = new PdfPCell(new Phrase(cid.getCompTerms()));	     
            celln.setRowspan(7);		      
            table.addCell(celln);*/
            
        	table.addCell(new Phrase("Discount",font));
	        PdfPCell vtCell=new PdfPCell(new Phrase("@"+salesInvoice.getTxtDiscount() +"%",font));			       
	        ...
	        PdfPCell chrCell =new PdfPCell(new Phrase(Convert.toString(salesInvoice.getTxtTransCost()),font));
	        ...
	        PdfPCell disCell =new PdfPCell(new Phrase(Convert.toString(salesInvoice.getTxtDisTotal()),font));
	        ...
	        //gtlCell.setBorder(1);
	        //gtlCell.setRowspan(9);
	        table.addCell(gtlCell);
	        PdfPCell gtCell =new PdfPCell(new Phrase(Convert.toString(salesInvoice.getTxtAmtPayble()),font));
        ...
        else if(rd.equals("amt"))
        {
        	...
        	table.addCell(new Phrase("Discount",font));
        	PdfPCell vtCell=new PdfPCell(new Phrase(Convert.toString(salesInvoice.getTxtDiscount()),font));			       
	        vtCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
	        table.addCell(vtCell);
			      ...
			      //  celln13.setBorderWidthBottom(0.5f);
			       ...
			       PdfPTable tablePN = new PdfPTable(4);
					...
					tablePN.setSpacingBefore(10);
						...
						cellPS.setPhrase(new Phrase("\n"+salesInvoice.getTxtpubNotes(),font));
						cellPS.setBorder(Rectangle.NO_BORDER);
						tablePN.addCell(cellPS);
