	 ...
	 if(selfromAc==seltoAc)
		 {
		 	...
		 	if(selID=='fromaccount')
		 		{
		 			fromAc.options[0].selected=true;
		 		}
		 	else
		 		{
		 			toAc.options[0].selected=true;
		 		}	 
		 	return false;
		 }
 }
						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="col-md-3">
									<div class="row">
										...
										<div class="col-md-5">
											<input type="text" value="<%=dt%>" name="date" id="date" class="form-control">
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="row">
										<div class="col-md-7">
											<form:label path="invoiceId">Invoice&nbsp;Id: </form:label>
										</div>
										<div class="col-md-5">
							...
							<div class="row">
								<div class="col-md-3" id="frmAc">
									<%-- <div class="row">
										<div class="col-md-7">
											<form:label path="fromaccount">From&nbsp;Account&nbsp;No&nbsp;:- </form:label>
										</div>
										<div class="col-md-3">
										<!-- accountList -->
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="row">
										...
										<div class="col-md-5">
											<input name="amount" id="amount" style="text-align: right;width: 90px;" class="form-control" onblur="checkAmt();" onkeypress="return isNumberKey(this)"></input>
										</div>
									</div>
								</div>
							</div><br>
