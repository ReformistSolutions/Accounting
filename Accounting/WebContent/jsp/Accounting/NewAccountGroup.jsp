...
<div class="col-md-12">
					<div class="panel">
						<div class="panel-body">
							...
							<div class="col-md-2">							
							<a href="frmAccountGroups.do" class="btn btn-primary btn-large"> Back</a>
							</div>
						</div>
					</div>
</div>
<form:form action="createGroupAccount.do" cssClass="form-inline" name="frmCreateAccount" modelAttribute="createGrpAccount" >
	         <div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="col-sm-3">
							<div>  
                            	<input type="hidden" name="txtAccGrpNo" id="txtAccGrpNo" value="${pgrpID.txtAccGrpNo}">
                            </div><br>
                            <div>  
                            	<input type="hidden" name="txtsAccGrpNo" id="txtsAccGrpNo" value="${sgrpID.txtsAccGrpNo}">
                            </div><br>
                   		...
                   		<div>  
                            ...
                            <div>                            
                            	<form:textarea path="txtDescription" rows="4" cols="50"  id="txtDescription" cssClass="form-control"></form:textarea>
                            	
                            </div><br>
                   			<div>
                   				
                   				<input type="submit" value="Create" name="btn" class="btn btn-primary">								
								<a href="frmAccountGroups.do" class="btn btn-primary btn-large"> Cancel</a>
                   			</div>
                   		</div>
