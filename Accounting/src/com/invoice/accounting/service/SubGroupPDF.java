...
public class SubGroupPDF extends AbstractPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		cell.setPhrase(new Phrase(newAccountGroup.getTxtsAccGrpNo(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableSR1.addCell(cell);	
		...
		cell.setPhrase(new Phrase("Parent Group Name :", font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN.addCell(cell);

		cell.setPhrase(new Phrase(newAccountGroup.getTxtParentacntgrp(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN.addCell(cell);
