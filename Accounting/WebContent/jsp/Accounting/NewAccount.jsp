	...
	<div id="wrapper">
		...
		<!-- <div class="container"> -->
			<%@include file="innerHeader.jsp"%>
				...
				<form:form action="createAccount.do" cssClass="form-inline" modelAttribute="createAccount" name="frmNewAccount">
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="col-sm-3">
							   ...
							   <div>
									<form:hidden path="txtNewAccNo" id="txtAcNm" readonly="true"></form:hidden>
								</div>
								
								<div>
									<form:input path="txtAccountName" id="txtAcNm" cssClass="form-control"
										></form:input>
								</div>
								<br>
								<div>
								
								<form:select path="txtAccountGroup" id="txtAcGrp" cssClass="form-control">
									
										<option>----Select----</option>
										
									    
									    <c:forEach items="${grpList}" var="grpList">									
										    <form:option value="${grpList.txtAccGrpNo}">${grpList.txtName}</form:option>
									    </c:forEach>
									    <c:forEach items="${grpsList}" var="grpsList">									
										    <form:option value="${grpsList.txtsAccGrpNo}">${grpsList.txtName}</form:option>
									    </c:forEach>
									</form:select>
								...
								<br>
								<div>
									<form:input path="txtOpeningBalance" title="Opening Balance" id="txtOpnBal" cssClass="form-control" onkeypress="return isNumberKey(this)"></form:input>
								</div>
								<br>
								<div>
									<input type="submit" value="Create" name="btn" class="btn btn-primary"> 
									<a href="accounting.do" class="btn btn-primary btn-large"> Cancel</a>
								</div>
