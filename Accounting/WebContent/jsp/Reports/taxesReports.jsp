    ...
    <div class="panel panel-default">
       <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab1" data-toggle="tab"><i class="glyphicon glyphicon-text-width"></i> Sales Total Taxses</a></li>
                                <li><a href="#tab2" data-toggle="tab"><i class="glyphicon glyphicon-text-width "></i> Purchase Total Taxes</a></li>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="panel">
					...
					<div><label>Total Tax: <u>${totalSalesTaxList.totalTaxAmt}</u></label></div>
				</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="panel">
					...
					<div><label>Total Tax: <u>${totalSalesLTaxList.totalLinkedTax}</u></label></div>
				</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-default"> 
			<div class="panel-body">
				<div class="panel">
					...
					<div><label>Total Tax: <u>${totalPurTaxList.totalTaxAmt}</u></label></div>
				</div>
				</div>
			</div>
		</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="panel">
					...
					<div><label>Total Tax: <u>${totalPurLTaxList.totalLinkedTax}</u></label></div>
				</div>
				</div>
			</div>
		</div>
