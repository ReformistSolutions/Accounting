...
<div class="panel panel-default">      
	...
	<div class="col-md-12">
		<div class="panel panel-default">
		<div class="panel-body">
		<form:form action="addSalesOrder.do" method="post" cssClass="form-inline" modelAttribute="salesOrder" name="frmsalesorder" onsubmit="return validateForm()">
							<div class="row">
								...
								<label>Customer&nbsp;Name:</label>
										...
										<div class="col-md-3">
								<input type="hidden" name="txtCName" id="txtCName" value="${salesOrder.custId}" class="form-control"></input> 
								<input type="text" value="${salesOrder.txtCName}" id="${salesOrder.custId}" readonly="readonly" class="form-control">
								<%-- select name="txtCName" id="txtCName" onchange="retriveAdd(this.value,this.id)" class="form-control">
										<option value="${salesOrder.custId}">${salesOrder.txtCName}</option>autofocus="autofocus"  onfocus="retriveAdd(this.value,this.id)"
								...
								<input type="hidden" id="txtEstID" name="txtEstID" value="${salesOrder.txtEstID}">
								</div>
									</div>		 
								</div>
							</div>
						...
						<table id="tableID" class="table table-striped">		
								...
								<tr>
									<td><input type="text" readonly="readonly" name="productList[${productList.srNo-1}].srNo" value="${productList.srNo}" id="productList[${productList.srNo-1}].srNo" style="width: 50px;text-align: right;" class="form-control" ></input></td>
												...
												<td><select readonly="readonly" name="productList[${productList.srNo-1}].itemCode" id="itemCode${productList.srNo-1}" onchange="showDesc(this.value,this.id);disQuantity(this.id);" class="form-control" style="width:120px;">
									...
									<td><input type="text" readonly="readonly" name="productList[${productList.srNo-1}].des" id="productList[${productList.srNo-1}].des" value="${productList.des}" class="form-control" style="width:120px;"></td>
