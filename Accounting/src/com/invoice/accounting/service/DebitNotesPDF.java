...
public class DebitNotesPDF  extends AbstractPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		NewDebitNote newDebitNote=(NewDebitNote) model.get("viewDebit");
		...
		cell3.setPhrase(new Phrase("DEBIT NOTES",font1));
		...
		cell.setPhrase(new Phrase(newDebitNote.getTxtVoucherNo(),font11));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableFR.addCell(cell11);
		...
		cell.setPhrase(new Phrase(newDebitNote.getTxtVoucherNo(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableSR1.addCell(cell);	
		...
		cell.setPhrase(new Phrase(newDebitNote.getTxtTransactionDate(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableSR.addCell(cell);	
		...
		cell.setPhrase(new Phrase(newDebitNote.getTxtFromAcnt(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN.addCell(cell);
		...
		cell.setPhrase(new Phrase(newDebitNote.getTxtToAcnt(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN1.addCell(cell);
		...
		cell.setPhrase(new Phrase(Convert.toString(newDebitNote.getTxtAmount()),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN2.addCell(cell);
		...
		cell.setPhrase(new Phrase(newDebitNote.getTxtDescription(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN3.addCell(cell);
