...
<br>
     <div class="col-md-12">	
		       <div class="panel panel-default">
			      ...
			      <c:if test="${message==0}">
	<div class="col-md-12">  
<div class="alert alert-danger" role="alert" id="failure">Available Product Quantity is Not Sufficient</div>
</div>
<script type="text/javascript">	
  $('#failure').fadeOut(5000, function() 
{
			      ...
			      <br>
			   <div class="col-md-12">
			   <form:form action="addInvoice.do" method="post" commandName="salesInvoice" cssClass="form-inline" name="frmsalesinvoice" onsubmit="return validateForm()"  >
		<div class="panel panel-default">
		<div class="panel-body">
				<div class="row first column">
					...
					<div class="col-md-2">
						<input type="text" id="date" value="<%=dt %>" style="width:130px;" name="txtDate" class="form-control"></input>
					</div>
					<div class="col-md-2" style="width:120px;">
						<label>Due&nbsp;Date:</label>
				    </div>
						<div class="col-md-2">
							<input type="text" id="ddate" style="width:130px;" name="txtDueDate" class="form-control"></input>
						</div>					
					</div>
				<%-- <div class="row"> 
						<div class="col-md-12">
							...
							<div class="col-md-1">	
							<label>Order&nbsp;Id:</label>	<!--orderList  -->								
						</div>
						<div class="col-md-2">
							<select name="orderId" id="orderId" style="width: 110px;" class="form-control">
								<option value="0">--Select--</option>
						...
						<div class="col-md-2">	
							<label>Customer&nbsp;Name:</label><!--orderList  -->								
						</div>
						<div class="col-md-3">
							<select name="txtCName" id="txtCName" style="width: 160px;" onchange="retriveAdd(this.value,this.id)" class="form-control">
								<option value="0">--Select Name--</option>
				...
				<div class="col-md-12">
					...
					<div class="col-md-4">
						<input type="text" id="date" value="<%=dt %>" name="txtDate" class="form-control"></input>
					</div>
						<div class="col-md-2">
							<label>Due Date:</label>
					    </div>
						<div class="col-md-4">
							<input type="text" id="ddate" name="txtDueDate" class="form-control"></input>
						</div>					
					</div>	<br>					
			</div>
...
<div class="row">
			<div class="col-md-5">
				...
				<div class="col-md-2">	 
					<form:textarea rows="2" cols="25" path="txtBillAddr" onkeyup="textAreaAdjust(this)" cssStyle="resize:none;" cssClass="form-control"></form:textarea>
				</div>
				</div>
			</div>
			<div class="col-md-6">
			<div class="row">
				...
				<div class="col-md-3">						 		      			      				
					<form:textarea rows="2" cols="25" path="txtShipAddr" onkeyup="textAreaAdjust(this)" cssStyle="resize:none;" cssClass="form-control"></form:textarea>
				</div>
			</div> 
		</div>			
		</div>
		...
		<div class="table-responsive">
						<table id="tableID" class="table table-striped">		
								...
								<tr>
									<td><input type="text" readonly="readonly" name="productList[${productList.srNo-1}].srNo" value="${productList.srNo}" id="productList[${productList.srNo-1}].srNo" style="width: 50px;text-align: right;" class="form-control" ></input></td>			
									<td>
										<select readonly="true" name="productList[${productList.srNo-1}].itemCode" id="itemCode${productList.srNo-1}" onchange="showDesc(this.value,this.id);disQuantity(this.id);" style="width:100px;" class="form-control" >
									...
									<td><input type="text" readonly="readonly" name="productList[${productList.srNo-1}].des" id="productList[${productList.srNo-1}].des" value="${productList.des}" style="width:120px;" class="form-control"></td>
									...
									<td><input type="text" readonly="readonly" name="productList[${productList.srNo-1}].quantity" id="productList[${productList.srNo-1}].quantity" value="${productList.quantity}" onkeypress="return isNumberKey(this)" onblur="calSubTotal(this.id);" class="form-control" style="width:80px;text-align: right;"></td>
					...
					<div class="panel-body">
                        ...
                        <div class="tab-content" style="padding: 1;">
                        	<div class="tab-pane fade in active" id="home">
                        		<p></p> 
                        		<form:textarea path="txtpubNotes" readonly="true" cssClass="form-control" cols="30" rows="5"/>
                        	</div>
				...
				<c:choose>
					<c:when test="${not empty salesInvoice.taxList}">
						<div style="height: 5px;"></div>
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-4">
