...
public class ReceiveForSalesPDF extends AbstractPdfView{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		ReceiveforSales receiveForSales=(ReceiveforSales) model.get("receiveforSalesView");
		...
		cell3.setPhrase(new Phrase("RECEIVE FOR SALES",font1));
		...
		f1.setColor(BaseColor.BLACK);
		    ...
		    celld1 = new PdfPCell(new Phrase("Voucher No      :"+"   "+receiveForSales.getTxtVNo(),f1));
		    celld1.setColspan(3);	    
		    tabled.addCell(celld1);
		    
		    celld2 = new PdfPCell(new Phrase("Date  :"+"   "+receiveForSales.getDate(),f1));
		    celld2.setColspan(3);
		    ...
		    celld11 = new PdfPCell(new Phrase("Warehouse Name :"+"       "+receiveForSales.getSelectWarehouse(),f1));
			...
			List<Details> issueDetails=new ArrayList<Details>();		
			issueDetails.addAll(receiveForSales.getProductList());
			for(Details issueproductList : issueDetails)
			{
				...
				cellit.setPhrase(new Phrase(issueproductList.getTxtItemr(), font));
		...
		tablePN.setWidths(new float[] {4.0f, 4.0f,2.0f, 2.0f});
		...
		cell.setPhrase(new Phrase(receiveForSales.getTxtDetails(),font));
		cell.setBorder(Rectangle.NO_BORDER);
