...
<%@ include file="../header.jsp" %>
	<div id="container">
			...
			<form:form action="paymentAdviceMail.do" cssClass="form-inline" modelAttribute="composeMail" name="frmSendMail" onsubmit="return validateForm()">
		            <div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-body">
								<div class="row">
								<div class="col-md-10">
									<div class="row">
										...
										<div class="col-md-10">
											...
											<input type="text" name="mailTo" id="mailTo" onblur="validateEmail(this.value)" style="width:350px;" class="form-control">
							...
							<div class="row">
								<div class="col-md-10">
									<div class="row">
										...
										<div class="col-md-8">
											<textarea name="body" id="body" rows="8" cols="52" class="form-control">Hello </textarea>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="row">
										...
										<input type="hidden" name="attachment" id="attachment" value="${attachment}" readonly="readonly" style="width: 200px;border: none;" class="form-control">
										<label><img src="<c:url value="/resources/images/PDF-icon.png" />" height="20" width="20"></img>&nbsp;&nbsp;${attachment}</label>
										<!-- <link rel="icon" href="<c:url value="/resources/images/favicon.ico" />" type="image/icon"> -->
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-3">
								<input type="submit" class="btn btn-primary" name="btn" value="Send"> <!-- onclick="javascript: history.go(-1)" -->
