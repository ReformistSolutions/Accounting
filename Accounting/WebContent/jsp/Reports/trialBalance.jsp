			...
			<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="col-md-10">
								<ul class="breadcrumb">
									<li class="active"><small>Trial Balance</small>
								</ul>
							</div>
					...
					<div class="panel panel-default">
						<div class="panel-body"> 
							<div class="panel panel-default" id="testTable">				         
				                <div class="panel-heading"><center>Trial Balance</center><br><center> As On 24 September 2014</center> </div>	
								<div class="table-responsive">
                                <table border="1" id="testTable1" width="820" class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                       		<th width="350" style="text-align: center;">Particulars</th>
                                            <th width="100" style="text-align: center;">O/P Bal  (<i class="fa fa-inr"></i>)</th>                                           
                                            ...
                                            <th width="100" style="text-align: center;">C/L Bal  (<i class="fa fa-inr"></i>)</th>                                                                                
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<%int i;for(i=1;i<=5;i++) {%>
