...
public class IssuePDF extends AbstractPdfView{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		IssueForProduction issueForProduction=(IssueForProduction) model.get("issueForProductionView");
		...
		cell3.setPhrase(new Phrase("ISSUE FOR PRODUCTION",font1));
		...
		f1.setColor(BaseColor.BLACK);
		    ...
		    celld1 = new PdfPCell(new Phrase("Voucher No      :"+"   "+issueForProduction.getTxtVNo(),f1));
		    celld1.setColspan(3);	    
		    tabled.addCell(celld1);
		    
		    celld2 = new PdfPCell(new Phrase("Date  :"+"   "+issueForProduction.getDate(),f1));
		    celld2.setColspan(3);
		    ...
		    celld11 = new PdfPCell(new Phrase("Warehouse Name :"+"       "+issueForProduction.getSelectWarehouse(),f1));
		...
		issueDetails.addAll(issueForProduction.getProductList());
		...
		cell.setPhrase(new Phrase(issueForProduction.getTxtDetails(),font));
		cell.setBorder(Rectangle.NO_BORDER);
