...
function showDetails()
{
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					document.getElementById("showstockwaste").innerHTML = xmlhttp.responseText;
				}
			}
		}
...
<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="col-md-8">
								<ul class="breadcrumb">
									<li class="active"><small>Record Wastage</small>
								</ul>
							</div>
							<div class="col-md-3">
...
<div class="col-md-12">	
   	   ...
   	   <div class="col-md-2">	    	     
   	    ...
   	    <div class="col-md-4">
         <div class="col-md-4"><input type="button" class="form-control" value="Search" onclick="showDetails();"> </div> 
                       ...
                       <div id="showstockwaste">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                    ...
                                    <tbody>
                                    <c:forEach items="${stockwaste}" var="showwastage">
                                        <tr class="odd gradeX">
