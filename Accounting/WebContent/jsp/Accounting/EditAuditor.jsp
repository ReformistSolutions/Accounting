...
<div id="wrapper">
	...
	<!-- <div class="container"> -->
		...
		<form:form action="updateAuditor.do" cssClass="form-inline" name="frmAddNewCustomer" commandName="updateNwAuditor" onsubmit="return validateForm()">
			<br>
			<div class="col-md-12">
					<div class="panel">
    ...
    <div class="panel panel-default">
              <div class="panel-body">	
       					...
       					<div>
							...
							<form:input path="txtAuditNo" cssClass="form-control" onkeypress="return AllowCharacters(this);"/>
							</div><br>
							...
							<br>           				
           				<div>
           				  <button id="submit" name="btn" value="Invite" class="btn btn-primary">Update</button>	
