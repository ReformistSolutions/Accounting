...
public class AccountPDF extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		NewAccount newAccount=(NewAccount) model.get("viewStaticAccount");
		...
		cell3.setPhrase(new Phrase("ACCOUNT",font1));
		...
		cell.setPhrase(new Phrase("Account No :", font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableSR1.addCell(cell);

		cell.setPhrase(new Phrase(Convert.toString(newAccount.getTxtNewAccNo())));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableSR1.addCell(cell);	
		...
		cell.setPhrase(new Phrase(newAccount.getTxtAccountName(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableSR.addCell(cell);	
		...
		cell.setPhrase(new Phrase("Account Group :", font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN.addCell(cell);

		cell.setPhrase(new Phrase(newAccount.getTxtAccountGroup(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN.addCell(cell);
		...
		cell.setPhrase(new Phrase(Convert.toString(newAccount.getTxtOpeningBalance()),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tablePN1.addCell(cell);
