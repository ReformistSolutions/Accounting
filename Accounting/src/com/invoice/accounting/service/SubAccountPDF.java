...
public class SubAccountPDF extends AbstractPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		NewAccount newAccount=(NewAccount) model.get("viewsubStaticAccount");
		...
		cell.setPhrase(new Phrase(newAccount.getTxtNewAccNo()));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(30f);
		tableSR1.addCell(cell);	
