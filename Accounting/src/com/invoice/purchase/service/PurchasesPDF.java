...
public class PurchasesPDF extends AbstractPdfView
{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		final String path = System.getProperty("user.dir");  
		 PdfWriter.getInstance(doc, new FileOutputStream(path+"/Purchases.pdf"));      
	        doc.open();	
		Purchases purchases=(Purchases) model.get("purchases");		
		...
		//cell3.setPadding(5);
		cell3.setPhrase(new Phrase("PURCHASE",font1));
		//cell3.setColspan(5);
		...
		f1.setColor(BaseColor.BLACK);
		    ...
		    celld1 = new PdfPCell(new Phrase("Vender Name     :"+"   "+purchases.getSelSupplierName(),f1));
		    celld1.setColspan(3);
		    tabled.addCell(celld1);
		    
		    celld2 = new PdfPCell(new Phrase("Billing Address  :"+"   "+purchases.getTxtAreaAddress(),f1));
		    celld2.setColspan(3);
		   ...
		   // doc.add(tabled);
		    ...
		    celld11 = new PdfPCell(new Phrase("Purchase No :"+"       "+purchases.getTxtPurchaseNo(),f1));
		    celld11.setColspan(3);
		    tabledd.addCell(celld11);	    	   
		    
		    celld13 = new PdfPCell(new Phrase("Date              :"+"      "+purchases.getTxtPurchaseDate(),f1));
		    celld13.setColspan(3);
		    tabledd.addCell(celld13);	
		    
		    celld14 = new PdfPCell(new Phrase("Due Date       :"+"      "+purchases.getTxtDueDate(),f1));
			...
			ordProductList.addAll(purchases.getProductList());
			//int flag=0;
			...
			ordTaxList.addAll(purchases.getTaxList());		
			...
			ordLinkedTaxList.addAll(purchases.getLinkedTaxList());	
			for(LinkedTaxDetails lTList : ordLinkedTaxList)
			{
			 ...
			 PdfPTable table = new PdfPTable(3);
		        ...
		        PdfPCell stCell=new PdfPCell(new Phrase(Convert.toString(purchases.getTxtSubTotal()),font));
		        ...
		        String rd=Convert.toString(purchases.getRadio());
		        if(rd.equals("per")){
		       ...
		       // celln.setBorderWidthBottom(0.5f);
		        ...
		        PdfPCell serCell = new PdfPCell(new Phrase(new Phrase(Convert.toString(purchases.getTxtDiscount()),font)));
		        ...
		        PdfPCell disCell =new PdfPCell(new Phrase(Convert.toString(purchases.getTxtDisTotal()),font));
		        ...
		        PdfPCell gtCell =new PdfPCell(new Phrase(Convert.toString(purchases.getTxtAmtPayble()),font));
		      ...
		      //  celln13.setBorderWidthBottom(0.5f);
		       ...
		       doc.add(tablel);
						...
						tablePN.setSpacingBefore(10);
							...
							cellPS.setPhrase(new Phrase(purchases.getTxtPubNotes(),font11));
							cellPS.setBorder(Rectangle.NO_BORDER);
							tablePN.addCell(cellPS);
			...
			estTaxList.addAll(purchases.getTaxList());		
			...
			estLinkedTaxList.addAll(purchases.getLinkedTaxList());	
	       ...
	       // table.addCell(new Phrase());
	        ...
	        String rd=Convert.toString(purchases.getRadio());
	        if(rd.equals("per")){
		        PdfPCell vtCell=new PdfPCell(new Phrase("@"+purchases.getTxtDiscount() +"%",font));			       
		        vtCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		        table.addCell(vtCell);
	        }
	        else
	        {
	        	PdfPCell vtCell=new PdfPCell(new Phrase(Convert.toString(purchases.getTxtDiscount()),font));			       
		        vtCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		        table.addCell(vtCell);
	        }
