...
<form:form action="addInvoice.do" method="post" commandName="salesInvoice" cssClass="form-inline" name="frmsalesinvoice" onsubmit="return validateForm()" >
		...
		<div class="panel-body">				
					...
					<div class="col-md-2" style="width:120px;">
						...
						<div class="col-md-2">
							<input type="text" id="ddate" name="txtDueDate" style="width:130px;" class="form-control"></input>
						</div>					
					</div>	<br>					
...
<div class="row">
			<div class="col-md-5">
				...
				<div class="col-md-2">	
					<form:textarea rows="2" cols="25" path="txtBillAddr" onkeyup="textAreaAdjust(this)" cssClass="form-control"></form:textarea>
				</div>
				</div>
			</div>
			<div class="col-md-6">
			<div class="row">
				...
				<div class="col-md-3">						 		      			      				
					<form:textarea rows="2" cols="25" path="txtShipAddr" onkeyup="textAreaAdjust(this)" cssClass="form-control"></form:textarea>
				</div>
			</div> 
		</div>			
		</div>
				...
				<div class="row"> 
						...
						<table id="tableID" class="table table-striped">		
								<tr>
									...
									<th>Description</th>
									<th>Unit</th>
									<th><label   style="display: none;" id="showth">A.Qty</label></th>
									<th>Quantity</th>
								...
								<tr>
									...
									<td><!-- estimateList -->
            						<select name="productList[0].itemCode" id="itemCode0" class="form-control" style="width:100px" onchange="showDesc(this.value,this.id);disQuantity(this.id);">
									...
									<td><input type="text" name="productList[0].des" id="productList[0].des" class="form-control" style="width:120px;"></td>
									<td><input type="text" name="unit0" id="unit0" class="form-control" readonly="readonly" style="width:80px;"></td>
									<td valign="middle"><label id="showLable0" style="color: red;display: none;font-size: 15;font-style: normal;"></label></td>
				...
				<div class="row">
					...
					<div class="col-md-6 pull right">
						<div class="row">
							...
							<div class="col-md-4">
								<form:input path="txtTransCost" cssClass="form-control" id="txtTransCost" onkeypress="return isNumberKey(this)" cssStyle="width:180px;" onblur="calculateCharges();"></form:input>
								<input type="hidden" name="hideTransCost" class="form-control" id="hideTransCost" value="0.0" style="width:180px;">
							</div>
						</div>
					</div>
				</div>
...
<c:if test="${message==0}">                     
<script>
	alert("Invoice Not Added Succesfully.");
</script>
</c:if>		
