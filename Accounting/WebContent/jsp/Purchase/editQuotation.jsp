...
function same(s)
{	
	var add=document.frmPurchaseQuotation.txtBillingTo.value;		 
	if(s.checked)
		{		
		  document.frmPurchaseQuotation.txtAreaShipto.value=add;		 
		}
	else
	{		
	  document.frmPurchaseQuotation.txtAreaShipto.value= " ";	  
	}	
}
</script>
	   ...
	   function delrow(obj)
		 {
			...
			var sr = id.slice(index1,index2);
	 		   ...
	 		   if(last == 1)
				 {
					document.getElementById("itemCode"+length).options[1].selected = true;
...
{	
	document.frm1.txtBillAddr.value = document.getElementById(document.frm1.txtCutName.value).value;
}
...
{
	 var index;
	 index= obj.id.slice(7);
	 var des = document.getElementById("txtDes"+index);
...
function validateForm()
{
	...
	if(document.frmPurchaseQuotation.txyQuotationNo.value=="")
	    {
	      alert("Quotation Number Should not be Empty...");
	      document.frmPurchaseQuotation.txyQuotationNo.focus();
	      return false;
	    }
	   else if(document.frmPurchaseQuotation.txtQuotationDate.value=="")
	      {
	          alert("Date field Should not be empty....");
	          document.frmPurchaseQuotation.txtQuotationDate.focus();
	          return false;
	        }
	  else if(document.frmPurchaseQuotation.txtCustName.value=="Select")
    {
      alert("Customer Name should not be blank");
      document.frmPurchaseQuotation.txtCustName.focus();
      return false;
    }   
    else if(document.frmPurchaseQuotation.txtBillingTo.value=="")
    {
      alert("Billing no field Should not be empty...");
      document.frmPurchaseQuotation.txtBillingTo.focus();
      return false;
    } 
     else if(document.frmPurchaseQuotation.txtAreaShipto.value=="")
    {
      alert("Ship to field should not be empty.....");
      document.frmPurchaseQuotation.txtAreaShipto.focus();
      return false;
    } 
  /*   else if(document.frmPurchaseQuotation.chkShipto.value=="")
    {
      alert("Ship to field should not be empty.....");
      document.frmPurchaseQuotation.chkShipto.focus();
      return false;
    } */
    else if(srno=="")
    {
    ...
    else if(document.frmPurchaseQuotation.txtSubTotal.value=="")
    {
      alert("SubTotal field should not be empty....");
      document.frmPurchaseQuotation.txtSubTotal.focus();
      return false;
    }
    else if(document.frmPurchaseQuotation.txtVat.value=="")
    {
      alert("Vat field should not be empty....");
      document.frmPurchaseQuotation.txtVat.focus();
      return false;
    }
    else if(document.frmPurchaseQuotation.txtServiceTax.value=="")
    {
      alert("ServiceTax field should not be empty....");
      document.frmPurchaseQuotation.txtServiceTax.focus();
      return false;
    }   
    else if(document.frmPurchaseQuotation.txtDiscout.value=="")
    {
      alert("Plz Enter The Discount.....");
      document.frmPurchaseQuotation.txtDiscout.focus();
      return false;
    }
    else if(document.frmPurchaseQuotation.txtTotal.value=="")
    {
      alert("Tax Total field should not be empty....");
      document.frmPurchaseQuotation.txtTotal.focus();
      return false;
    }
    else if(document.frmPurchaseQuotation.txtPubNotes.value=="")
    {
      alert("Public Note field should not be empty.....");
      document.frmPurchaseQuotation.txtPubNotes.focus();
      return false;
    }
    else if(document.frmPurchaseQuotation.txtPvtNotes.value=="")
    {
      alert("Private Note field should not be empty.....");
      document.frmPurchaseQuotation.txtPvtNotes.focus();
      return false;
    }
    else
    {
...
{	
	...
	if(s.checked)
		{
		  prevAdd = document.frmPurchaseQuotation.txtAreaShipto.value;	
		  document.frmPurchaseQuotation.txtAreaShipto.value=add;
		}
	else
	{
	  document.frmPurchaseQuotation.txtAreaShipto.value= prevAdd;
	}
}
</script>
</head>
...
<%@ include file="../header.jsp" %>
	...
	<input type="hidden" name="hide" id="hidden" />
		...
		<br>
		<form:form action="updatePurchaseQuotation.do" onsubmit="return validateForm()" name="frmPurchaseQuotation" cssClass="form-inline"  modelAttribute="editQuoatation">
		<div class="col-md-12">
		<div class="panel panel-default">
		<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">		
							<form:select path="txtCustName" cssClass="form-control"> 
								<option>${editQuoatation.txtCustName}</option>
			...
			<div class="col-md-6">
				<div class="row">
					<div class="col-md-4">
					<form:label path="txyQuotationNo">Quotation No : </form:label>
					</div>
					<div class="col-md-4"> 
					<form:input path="txyQuotationNo" cssClass="form-control" readonly="true" cssStyle="width:100px"></form:input>
					</div>
				</div>		 
			</div>
		</div><br>
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
						<input type="text" id="dp1" class="form-control" name="txtQuotationDate" value="${editQuoatation.txtQuotationDate}"/>		
					</div>
				</div>
			</div>	
		</div>
		...
		<div class="row">
					...
					<div class="col-md-4">					
					<form:textarea rows="2" cols="25" cssClass="form-control" path="txtBillingTo" onkeyup="textAreaAdjust(this)" style="overflow:hidden"></form:textarea>
					</div>
        	...
        	<input type="checkbox" id="chkYes" name="chkYes" onclick="same(this)" style="vertical-align: top">        		
      		...
      		<div class="col-md-3">	
			<form:textarea rows="2" cols="25" cssClass="form-control" path="txtAreaShipto" onkeyup="textAreaAdjust(this)" style="overflow:hidden"></form:textarea>
			</div> 
		</div><br>
		<div class="table-responsive" style="width: 90%;">	
			<table class="table table-striped" id="tableID">
				...
				<tbody>
				<c:forEach items="${editQuoatation.productList }" var="productList">	
					<tr>
						<td><input type="text" id="productList[${productList.srNo-1}].srNo" name="productList[${productList.srNo-1}].srNo" value="${productList.srNo}" class="form-control" style="width:50px;text-align: right;"></td>
						<td>
            						<select name="productList[${productList.srNo-1}].itemCode" id="itemCode${productList.srNo-1}"  class="form-control" onchange="showDesc(this.value,this.id);showUnitPrice(this.value,this.id);">
										<option value="Select">---Select---</option>
										<option value="${productList.prodId}" id="${productList.prodId}">${productList.itemCode}</option>										
										
												<c:forEach items="${pList}" var="pList">
													<option value="${pList.productId}">${pList.txtName}</option>
											    </c:forEach>
											    <script type="text/javascript">			
						...
						<td><form:input path="productList[${productList.srNo-1}].des" id="productList[${productList.srNo-1}].des" cssClass="form-control"></form:input></td>
						<td><form:input path="productList[${productList.srNo-1}].unit" readonly="true" id="productList[${productList.srNo-1}].unit" cssClass="form-control" style="width:80px;"></form:input></td>
						<td><input type="text" name="productList[${productList.srNo-1}].quantity" id="productList[${productList.srNo-1}].quantity" value="${productList.quantity}" class="form-control" style="width:80px;text-align: right;" onblur="calSubTotal(this.id)"></td>
						<td><input type="text" name="productList[${productList.srNo-1}].unitPrice"	id="productList[${productList.srNo-1}].unitPrice" value="${productList.unitPrice}" class="form-control" style="width:80px;text-align: right;" onblur="calSubTotal(this.id)"></td>
						
						<td><input type="text" name="productList[${productList.srNo-1}].itemTotal" id="productList[${productList.srNo-1}].itemTotal" value="${productList.itemTotal}" class="form-control" style="width:80px;text-align: right;" onfocus="total()">
		...
		<div class="first-column">
					...
					<div class="panel-body">
                        ...
                        <div class="tab-content">
                        	<div class="tab-pane fade in active" id="home">
                        		<p></p>
                        		<form:textarea path="txtPubNotes" cssClass="form-control" cols="37" rows="5"/>
                        	</div>
			...
			<%-- <div class="col-md-7">
				...
				<div class="col-md-12">
					...
					<div class="col-md-5">
						<input type="text" name="txtSubTotal" readonly="readonly" id="txtSubTotal" class="form-control" value="${ editQuoatation.txtSubTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div> 
				...
				<div class="col-md-12">
					<div class="col-md-3">
						<div class="row">
						<c:choose>
						<c:when test="${ editQuoatation.radio=='per'}">
							<input id="radio1" type="radio" name="radio" value="per" checked="checked" onclick="calDis()1;"><label>&nbsp;%&nbsp;</label>
							<input id="radio2" type="radio" name="radio" value="amt" onclick="calDis()1;"><label>&nbsp;Amount&nbsp;</label>
						</c:when>
						<c:otherwise>
					...
					<div class="col-md-5">
						<input type="text" name="txtDiscount" id="txtDiscount" value="${ editQuoatation.txtDiscount}" class="form-control" onkeypress="return isNumberKey(this)" onblur="calDis();"></input>
					</div>					
					<br>
				</div>				
				</div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="text" name="txtDisTotal" readonly="readonly" id="txtDisTotal" class="form-control" value="${ editQuoatation.txtDisTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>	
				<c:choose>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="row">
							...
							<input type="checkbox" name="applyTax" id="applyTax" onclick="checkTaxes()" checked="checked" value="tax" /><label>&nbsp;Apply&nbsp;Tax</label>
						</div>
						</div>
						<div class="col-md-4"></div>
						<div class="col-md-5"></div>
...
<tbody>
<%int cnt=1; %>
<c:forEach items="${editQuoatation.taxList}" var="taxDetailsList">
<tr>
<td>
...
<option value="${taxDetailsList.taxRate}^${taxDetailsList.taxId}">${taxDetailsList.taxType}&nbsp;@&nbsp;${taxDetailsList.taxRate}</option>
<option value="---Select---">---Select---</option>
...
<div id="linkedDiv">
<%int count=1; %>
	<c:forEach items="${editQuoatation.linkedTaxList}" var="linkedTaxList">
		<div>
...
<td><input type="hidden" id="taxList[1].txtPrevTax" name="taxList[1].txtPrevTax" value="0.0" class="form-control"/></td><!--  onblur="getvalue(this.value)" -->
<td><input type="hidden" id="taxList[1].txtprevLinkTax" name="taxList[1].txtprevLinkTax" value="0.0" class="form-control" /></td>
...
<tr><td colspan="5" id="getTax1"></td></tr>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="hidden" name="txtTaxTotal" value="${editQuoatation.txtTaxTotal}" id="txtTaxTotal" class="form-control"/>
						<input type="text" name="txtRoundOff" value="${editQuoatation.txtRoundOff}" readonly="readonly" id="txtRoundOff" class="form-control" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
				<div style="height: 5px;"></div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						...
						<input type="text" name="txtAmtPayble" readonly="readonly" id="txtAmtPayble" class="form-control" value="${editQuoatation.txtAmtPayble}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
		...
		<div class="col-md-12">			 
				...
				<a href="purchaseQuotation.do" class="btn btn-primary btn-large" data-toggle="tooltip" data-placement="top" title="Cancel"> Cancel</a>
		</div>
		</div>									
		</div>
		</div>			
