		...
		<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li class="active"><small><i class="fa fa-2x fa-table"></i></small>&nbsp;Purchases<small>&nbsp;</small>
			             	...
			             	<div class="col-md-2">
			             	<a href="purchases.do" class="btn btn-primary btn-large"> Back</a>
			             	</div>
		             	</div>
		             	</div>
		</div>
		<br>
			<form:form action="updatePurchase.do" onsubmit="return validateForm()" name="frmPurchaseOrder"  cssClass="form-inline"  modelAttribute="purchases">
		<div class="col-md-12">
		<div class="panel panel-default">
		<div class="panel-body">
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<form:select path="selSupplierName" cssClass="form-control">  
							<option value="${purchases.venderID}">${purchases.selSupplierName}</option>
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">   
					<input tyep="text" name="txtPurchaseNo" class="form-control" value="${purchases.txtPurchaseNo}" readonly="readonly" style="width:100px"></input>
					</div>
				</div>		 
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
						<input type="text" id="dp1" name="txtPurchaseDate" class="form-control" value="${purchases.txtPurchaseDate}"/>
					</div>
				</div>
		...
		<div class="table-responsive" style="width: 90%;"> 	
			<table class="table table-striped" id="tableID">
				...
				<c:forEach items="${purchases.productList}" var="pList">
					<tr>
						<td><input type="text" id="productList[${pList.srNo-1}].srNo" name="productList[${pList.srNo-1}].srNo" value="${pList.srNo}"  class="form-control" style="width:50px;text-align: right;"></td>
						<td>
            						<select name="productList[${pList.srNo-1}].itemCode" id="itemCode${pList.srNo-1}" class="form-control"  onchange="showDesc(this.value,this.id);showUnitPrice(this.value,this.id);">
												<option value="Select">---Select---</option>
						...
						<td><input type="text" name="productList[${pList.srNo-1}].des" id="productList[${pList.srNo-1}].des" value="${pList.des}" class="form-control"  ></input></td>
						<td><input type="text" name="productList[${pList.srNo-1}].unit" readonly="readonly" id="productList[${pList.srNo-1}].unit" value="${pList.unit}" class="form-control" style="width:80px;"></input></td>
						<td><input type="text" name="productList[${pList.srNo-1}].quantity" id="productList[${pList.srNo-1}].quantity" value="${pList.quantity}" onkeypress="return isNumberKey(this)" onblur="calSubTotal(this.id)" class="form-control" style="width:80px;text-align: right;"></td>
					...
					<div class="panel-body">
                        ...
                        <div class="tab-content">
                        	<div class="tab-pane fade in active" id="home">
                        		<p></p>
                        		<textarea name="txtPubNotes" class="form-control" cols="28" rows="5">${ purchases.txtPubNotes}</textarea>
                        	</div>
...
<option value="---Select---">---Select---</option>
<option selected="selected" value="${taxDetailsList.taxRate}^${taxDetailsList.taxId}">${taxDetailsList.taxType}&nbsp;@&nbsp;${taxDetailsList.taxRate}</option>
<c:forEach items="${taxList}" var="taxList">
 <option value="${taxList.taxRate}^${taxList.taxId}">${taxList.taxName}&nbsp;@&nbsp;${taxList.taxRate}</option>
</c:forEach>
</select>
...
<tr><td colspan="5" id="getTax1"></td></tr>
		...
		<div class="col-md-12"> 
			...
			<a href="purchases.do" class="btn btn-primary btn-large" data-toggle="tooltip" data-placement="top" title="Cancel"> Cancel</a>
		</div>			
		</div>
		</div>
		</div>
