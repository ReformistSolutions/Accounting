...
<script type="text/javascript">
	...
	function addRowWaste() {
		...
		j++;
         ...
         inputSrNo.id = "expenseDetailsList["+length+"].txtSrNo1";/* "txtSrNo" + i; */    
         inputSrNo.value=j;
...
<form:form action="addcreateexpense.do" method="post" cssClass="form-inline" modelAttribute="createexpense" name="frmwarehouse"> 
<div class="col-md-12">
<div class="panel panel-default">                       
<div class="panel-body">
						<div class="row">
								...
								<div class="col-md-5">
								<form:input path="expid" id="expid" value="${EXPID.expid}" cssClass="form-control" readonly="true" style="width: 100px;"></form:input>
								</div>
								</div>
								</div>
								</div><br>
							<div class="row">
								<div class="col-md-6">
									...
									<div class="row">
										...
										<div class="col-md-5">  
											<form:select path="paidfrom" id="paidfrom" cssClass="form-control" >
								...
								<div class="col-md-6">
									<div class="row">
										...
										<div class="col-md-5">  
															 <input type="text" id="dp1" name="expdate" class="form-control" style="width: 160px;" />								
									</div>
								</div>								
							</div>
							</div><br>
					...
					<div class="table-responsive" style="width: 70%;">
						<table id="expense" class="table table-striped">
							...
							<tr>
							        <td><input name="expenseDetailsList[0].txtSrNo1" id="expenseDetailsList[0].txtSrNo1" class="form-control" style="width: 50px; text-align: right;" onkeypress="return isNumberKey(this)" value="1" /></td>
															<td><form:select path="expenseDetailsList[0].txttype" id="expenseDetailsList[0].txttype" onchange="showDesc(this.value,this.id)" class="form-control">
																	<option value="Select">----Select----</option>
															...
															<td><input name="expenseDetailsList[0].remark" id="expenseDetailsList[0].remark" class="form-control" style="text-align: right; width: 110px;" /></td>
															<td><input name="expenseDetailsList[0].txtamount" id="expenseDetailsList[0].txtamount" class="form-control" style="text-align: right; width: 80px;" onblur="calSubTotal(this.id)" /></td>
															<td><input type="hidden" name="txtexamount0" id="txtexamount0" value="0.0" class="form-control" style="text-align: right; width: 80px;"/></td>
															<td class="fnt"><input type="button" id="btndel0" name="btndel0" class="btn btn-danger" value="-" onclick="delrowWaste(this.id);"></td>
														</tr>
												...
												<div>
													<textarea name="narration" rows="4" cols="35"
