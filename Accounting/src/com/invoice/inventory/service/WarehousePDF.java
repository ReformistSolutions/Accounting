...
public class WarehousePDF extends AbstractPdfView{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		cell3.setPhrase(new Phrase("Warehouse Details",font1));
		...
		f1.setColor(BaseColor.BLACK);
		    ...
		    celld1 = new PdfPCell(new Phrase("Warehouse ID    :"+"   "+warehouse.getWarehousrID(),f1));
		    celld1.setColspan(3);	    
		    tabled.addCell(celld1);
		    
		    celld2 = new PdfPCell(new Phrase("Warehouse Name  :"+"   "+warehouse.getWareHouseName(),f1));
		    celld2.setColspan(3);
		    ...
		    celld11 = new PdfPCell(new Phrase("Warehouse Address :"+"       "+warehouse.getAddress(),f1));
			...
			List<WarehouseDetails> warehouseDetails=new ArrayList<WarehouseDetails>();		
			warehouseDetails.addAll(warehouse.getWarehousedetails());
			
			for(WarehouseDetails warehouselist : warehouseDetails)
			{
			{
				
				PdfPCell cell20 = new PdfPCell(); 
				cell20.setPhrase(new Phrase(Convert.toString(warehouselist.getSrNo())));
				cell20.setHorizontalAlignment(Element.ALIGN_RIGHT);
				tableDetails.addCell(cell20);
				
				PdfPCell cellit = new PdfPCell();
				cellit.setPhrase(new Phrase(warehouselist.getItemCode(), font));
				tableDetails.addCell(cellit);	
			
				PdfPCell cell21 = new PdfPCell();
				cell21.setPhrase(new Phrase(Convert.toString(warehouselist.getQuantity()), font));
	...
	cell.setPhrase(new Phrase(warehouse.getComments(),font));
	cell.setBorder(Rectangle.NO_BORDER);
