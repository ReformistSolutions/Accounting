...
function addTax()
{
	...
	inputTax.style.width='150px'; 
		...
		inputTax.onchange=function(){showLinkedTax(this.value,this.id);checkTax(this.id);};
...
<br>
	<div class="col-md-12">
	<form:form action="addEstimate.do" method="post" commandName="salesEstimate" name="frmSalesEstimate" onsubmit="return validateForm()">
		<div class="panel panel-default">
		<div class="panel-body">		
						<div class="row">
						<div class="col-md-12">
				...
				<div class="col-md-3">
					<form:textarea rows="2" cols="25" cssStyle="resize:none;" onkeyup="textAreaAdjust(this)" cssClass="form-control" path="txtShipAddr" id="txtShipAddr"></form:textarea>
				</div>
			</div> 
		</div>
	</div>	<br>	
					...
					<div class="table-responsive">
						<table id="tableID" class="table table-striped">		
								...
								<tr>
									...
									<td><!-- estimateList -->
            						<select name="productList[0].itemCode" id="itemCode0" class="form-control" style="width:100px" onchange="showDesc(this.value,this.id);">
...
<c:forEach items="${taxList1}" var="taxList1">
