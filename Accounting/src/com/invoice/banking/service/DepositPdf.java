...
public class DepositPdf extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		Deposit deposit=(Deposit) model.get("deposits");
CompanyDetails cid=(CompanyDetails) model.get("compInfo");
		...
		tableHD.setSpacingBefore(10);
			...
			cell3.setPhrase(new Phrase("DEPOSIT RECEIPT",font1));			
	...
	cell0.setPadding(5);
		...
		cell.setPhrase(new Phrase(deposit.getTxtdepoVchrNo(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tableFR.addCell(cell);
		...
		cell.setPhrase(new Phrase(deposit.getTxtdepodate(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tableSR.addCell(cell);	
		...
		cell.setPhrase(new Phrase(deposit.getTxtdepoFrmAccnt(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN.addCell(cell);
		...
		cell.setPhrase(new Phrase(deposit.getTxtdepoToAccnt(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN1.addCell(cell);
		...
		cell.setPhrase(new Phrase(deposit.getTxtdepoTransType(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN2.addCell(cell);
		...
		cell.setPhrase(new Phrase(Convert.toString(deposit.getTxtdepoAmount())));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN3.addCell(cell);
		...
		cell.setPhrase(new Phrase(deposit.getTxtdepoDesc(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN4.addCell(cell);
