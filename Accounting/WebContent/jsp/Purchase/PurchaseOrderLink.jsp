	...
	<input type="hidden" id="hide" name="hide1"> 
		...
		<div class="col-md-12">
						...
						<ul class="breadcrumb">
							<li class="active"><small><i class="fa fa-2x fa-table"></i></small>&nbsp;Purchase<small>&nbsp;Order</small>
			             	...
			             	<div class="col-md-2">
			             	<button name="back" class="btn btn-primary btn-large" onclick="backPage()" data-toggle="tooltip" data-placement="left" title="Back"><i class="fa fa-reply"></i> Back</button>
			             	</div>
		             	</div>
		             	</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
					<input type="hidden" name="selSupplierName" value="${purchaseOrder.venderID}" class="form-control" readonly="readonly">
					<input type="text" name="supplierName" value="${purchaseOrder.selSupplierName}" class="form-control" readonly="readonly">
						<%-- <form:select path="selSupplierName" cssClass="form-control">  
							<option>${purchaseOrder.VenderID} ${purchaseOrder.selSupplierName}</option>
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">   
					<input type="text" name="txtPurchaseOrdNo" id="txtPurchaseOrdNo" class="form-control" value="${purchaseOrder.txtPurchaseOrdNo}" readonly="true" style="width:100px"></input>
					<input type="hidden" name="selQuotatonNo" value="${purchaseOrder.selQuotatonNo}">
					</div>
				</div>		 
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
					...
					<%
											...
											%> 
						<input type="text" id="dp1" name="txtPurcaseDate" class="form-control" value="<%=dt%>"/>
					</div>
				</div>
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-4">
						<input type="text" id="dp2" name="txtDueDate" class="form-control" value="${purchaseOrder.txtDueDate}"/>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="row">
				<div class="col-md-4">
					<form:label cssStyle="vertical-align; top;" path="txtAreaAddress">Address : </form:label>
				</div>
				<div class="col-md-4">	
					<textarea name="txtAreaAddress" rows="2" cols="25" class="form-control" onkeyup="textAreaAdjust(this)" style="overflow:hidden">${purchaseOrder.txtAreaAddress}</textarea>
				</div>
				</div>
			</div>			
		</div>
		...
		<div class="table-responsive" style="width: 90%;"> 	
			<table class="table table-striped" id="tableID">
				...
				<c:forEach items="${purchaseOrder.productList}" var="pList">
					<tr>
						<td><input type="text" id="productList[${pList.srNo-1}].srNo" readonly="readonly" name="productList[${pList.srNo-1}].srNo" value="${pList.srNo}"  class="form-control" style="width:50px;text-align: right;"></td>
						<td>
            						<select name="productList[${pList.srNo-1}].itemCode" readonly="true" id="itemCode${pList.srNo-1}" class="form-control"  onchange="showDesc(this.value,this.id);showUnitPrice(this.value,this.id);">
												<option value="Select">---Select---</option>
											<option value="${pList.prodId}" id="${pList.prodId}">${pList.itemCode}</option>										
									
												<c:forEach items="${productList}" var="pOrderList">
													<option value="${pOrderList.productId}">${pOrderList.txtName}</option>													
											    </c:forEach>
											    <script type="text/javascript">			
													var i=${pList.srNo-1};												
							        ...
							        <!-- <script type="text/javascript">
							        		var ddlTax = document.getElementById("productList[${pList.srNo-1}].itemCode");
							        		ddlTax.options["${pList.taxType}"].selected=true;
							        	</script> -->
            					</td>
						<td><input type="text" name="productList[${pList.srNo-1}].des" readonly="readonly" id="productList[${pList.srNo-1}].des" value="${pList.des}" class="form-control"  ></input></td>
						<td><input type="text" name="productList[${pList.srNo-1}].unit" readonly="readonly" id="productList[${pList.srNo-1}].unit" value="${pList.unit}"  style="width:80px;"  class="form-control"></td>
						<td><input type="text" name="productList[${pList.srNo-1}].quantity" readonly="readonly" id="productList[${pList.srNo-1}].quantity" value="${pList.quantity}" onkeypress="return isNumberKey(this)" onblur="calSubTotal(this.id)" class="form-control" style="width:80px;text-align: right;"></td>
									<td><input type="text" name="productList[${pList.srNo-1}].unitPrice"	id="productList[${pList.srNo-1}].unitPrice" value="${pList.unitPrice}" onkeypress="return isNumberKey(this)" onblur="calSubTotal(this.id)" class="form-control" style="width:80px;text-align: right;"></td>
									<td><input type="text" name="productList[${pList.srNo-1}].itemTotal" id="productList[${pList.srNo-1}].itemTotal" value="${pList.itemTotal}" class="form-control" style="width:80px;text-align: right;"></td>
									<td><input type="hidden" name="productList[${pList.srNo-1}].exSubTotal" id="productList[${pList.srNo-1}].exSubTotal" class="form-control" value="${pList.itemTotal}" style="width:80px;text-align: right;"></td>
									 
									<td><input type="button" class="btn btn-danger" name="productList[${pList.srNo-1}].btndel" id="productList[${pList.srNo-1}].btndel" value="-" onclick="delrow(this.id);"></td>
								</tr>	</c:forEach>						
							</table> 
		...
		<div class="first-column">			
					...
					<div class="panel-body">
                        ...
                        <div class="tab-content">
                        	<div class="tab-pane fade in active" id="home">
                        		<p></p>
                        		<textarea name="txtPubNotes" class="form-control" cols="28" rows="5">${purchaseOrder.txtPubNotes}</textarea>
                        	</div>
                        	<div class="tab-pane fade" id="profile">
                        		<p></p> 
                        		<textarea name="txtPvtNotes" class="form-control" cols="28" rows="5">${purchaseOrder.txtPvtNotes}</textarea>
                        	</div>
                        </div>
					</div>
				</div>
			...
			<div class="col-md-7">
				...
				<div class="col-md-12">
					...
					<div class="col-md-5">
						<input type="text" name="txtSubTotal" readonly="readonly" id="txtSubTotal" class="form-control" value="${ purchaseOrder.txtAmtPayble}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div> 
				...
				<div class="row"  id="showDis" style="display: none;">
				<div class="col-md-12">
					<div class="col-md-3">
						<div class="row">
						<%-- <c:choose>
						<c:when test="${ purchaseOrder.radio=='per'}">
					...
					<div class="col-md-5">
						<input type="text" name="txtDiscount" id="txtDiscount" value="${ purchaseOrder.txtDiscount}" class="form-control" onkeypress="return isNumberKey(this)" onblur="calDis();"></input>
					</div>					
					<br>
				</div>				
				</div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="text" name="txtDisTotal" readonly="readonly" id="txtDisTotal" class="form-control" value="${ purchaseOrder.txtDisTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
				<%-- <c:choose>
				<c:when test="${not empty purchaseOrder.taxList}">
				<div style="height: 5px;"></div>
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-3">
...
<tbody>
<%int cnt=1; %>
<c:forEach items="${purchaseOrder.taxList}" var="taxDetailsList">
<tr>
<td>
...
<div id="linkedDiv">
<%int count=1; %>
	<c:forEach items="${purchaseOrder.linkedTaxList}" var="linkedTaxList">
		<div>
...
<select title="" name="taxList[1].taxType" id="taxList[1].taxType" style="width:170px;" class="form-control" onchange="showLinkedTax(this.value,this.id);"> <!-- cal(this.id);showLinkedTax(this.value,this.id); -->
...
<%-- </c:otherwise>			
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="hidden" name="txtTaxTotal" value="${purchaseOrder.txtTaxTotal}" id="txtTaxTotal" class="form-control"/>
						<input type="text" name="txtRoundOff" value="${purchaseOrder.txtRoundOff}" readonly="readonly" id="txtRoundOff" class="form-control" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
				<div style="height: 5px;"></div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						...
						<input type="text" name="txtAmtPayble" readonly="readonly" id="txtAmtPayble" class="form-control" value="${purchaseOrder.txtAmtPayble}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
			</div>
		...
		<div class="col-md-12"> 
			...
			<button type="button" onclick="cancel();" class="btn btn-primary" name="btn" data-toggle="tooltip" data-placement="top" title="Save">Cancel</button>
		</div>			
		</div>
		</div>
		</div>
