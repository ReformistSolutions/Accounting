...
<!-- 	<div class="container"> -->
	<form:form action="deposit.do" cssClass="form-inline" commandName="depositView" name="frmDeposit" onsubmit="return validateForm2()">
    ...
    <div class="panel panel-default">
       ...
       <div class="panel-body">
                        <div class="col-sm-3">	                         
                   		...
                   		<div class="col-sm-9">                   		
                   		<div>  
                            	<label>${depositView.txtdepoVchrNo}</label>
                            </div><br>
                            
                            <div>  
                            <label>${depositView.txtdepodate}</label>
                            </div><br>
                            
                            <div>     
                                  <label>${depositView.txtdepoFrmAccnt}</label>              
                            </div>
                            <br>                      
                          <div>      
                            	<label>${depositView.txtdepoToAccnt}</label>
                            </div><br>
                            
                             <div>      
                            	<label>${depositView.txtdepoTransType}</label>
                            </div><br>
                            
                            <div>  
                            	<label>${depositView.txtdepoAmount}</label>
                            </div><br>
                            
                            <div>                            
                            	<label>${depositView.txtdepoDesc}</label>                            	
                            </div><br>                         
                           	</div>
                        </div>                  
                        <div class="col-md-12">
                        <center>
						<input type="button" value="Print" name="btn" class="btn btn-primary" onclick="urlSubmit('depositPDF.do?voucherNo=${depositView.txtdepoVchrNo}','_blank')">									 
<%-- 						<input type="button" value="E-Mail" name="btn" class="btn btn-primary" onclick="urlSubmit('composeMail.do?voucherNo=${depositView.txtdepoVchrNo}','_blank')">
 --%>						</center>
				</div>
