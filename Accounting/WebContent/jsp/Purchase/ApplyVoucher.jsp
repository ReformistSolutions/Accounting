	...
	<!-- <div id="container"> -->
		<%@ include file="innerHeader.jsp" %>
					...
					<!-- <div class="container">		 -->		<br>			
		             ...
		             <form:form action="addVoucher.do" cssClass="form-inline" modelAttribute="applyVoucher">
		            <div class="col-md-12">
						<div class="panel">
							<div class="panel-body">
								<div class="row">
								...
								<div class="col-md-4">
									<div class="row">
										...
										<div class="col-md-7">
											<input type="text" name="orderId" class="form-control" value="${applyVoucher.orderId}" readonly="readonly" autofocus="autofocus" onfocus="showAvlBalance(this.value);" id="${applyVoucher.orderId}">											
										</div>
									</div>
								</div>					
							</div><br>
							...
							<div class="row">
								...
								<button type="button" onclick="cancel();" class="btn btn-primary" name="btn">Cancel</button>
								</div>
