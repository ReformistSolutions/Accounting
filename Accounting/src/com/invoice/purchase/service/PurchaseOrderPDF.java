...
public class PurchaseOrderPDF extends AbstractPdfView
{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		final String path = System.getProperty("user.dir");  
		 PdfWriter.getInstance(doc, new FileOutputStream(path+"/Purchase Order.pdf"));      
	        doc.open();	
		PurchaseOrder purchaseOrder=(PurchaseOrder) model.get("vieweorder");
		...
		//cell3.setPadding(5);
		cell3.setPhrase(new Phrase("PURCHASE ORDER",font1));
		//cell3.setColspan(5);
		...
		doc.add(tableHD);
		 ...
		 Paragraph p2 = new Paragraph(cid.getCompDesc()+"\n\n"+cid.getCompAddress()+"\n\nContact No :  "+cid.getContactNo()+"\n\nEmail :  "+cid.getEmail()+"\n"+" ", new
		        ...
		        doc.addTitle("Purchase Order PDF");
		        doc.add(tblHeaderIn);
		...
		f1.setColor(BaseColor.BLACK);
		    ...
		    celld1 = new PdfPCell(new Phrase("Vender Name      :"+"   "+purchaseOrder.getSelSupplierName(),f1));
		    celld1.setColspan(3);
		    tabled.addCell(celld1);
		    
		    celld2 = new PdfPCell(new Phrase("Billing Address  :"+"   "+purchaseOrder.getTxtAreaAddress(),f1));
		    celld2.setColspan(3);
		   ...
		   // doc.add(tabled);
		    ...
		    PdfPCell celld11,celld13,celld14;
		    
		    celld11 = new PdfPCell(new Phrase("Order No :"+"       "+purchaseOrder.getTxtPurchaseOrdNo(),f1));
		    celld11.setColspan(3);
		    tabledd.addCell(celld11);	    	   
		    
		    celld13 = new PdfPCell(new Phrase("Date :       "+"       "+purchaseOrder.getTxtPurcaseDate(),f1));
		    celld13.setColspan(3);
		    tabledd.addCell(celld13);	
		    
		    celld14 = new PdfPCell(new Phrase("Due Date :      "+""+purchaseOrder.getTxtDueDate(),f1));
			...
			ordProductList.addAll(purchaseOrder.getProductList());
			//int flag=0;
			...
			qutTaxList.addAll(purchaseOrder.getTaxList());		
			...
			qutLinkedTaxList.addAll(purchaseOrder.getLinkedTaxList());	
			for(LinkedTaxDetails lTList : qutLinkedTaxList)
			{
				...
				tableLinkedTaxDetails.addCell(cell21);
					 ...
					 PdfPTable table = new PdfPTable(2);
				        ...
				        PdfPCell stCell=new PdfPCell(new Phrase(Convert.toString(purchaseOrder.getTxtSubTotal()),font));
				        stCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
				        table.addCell(stCell);
				       // table.addCell(new Phrase());
				        table.addCell(new Phrase("Discount Type",font));
				        String rd=Convert.toString(purchaseOrder.getRadio());
				        if(rd.equals("per")){
				       ...
				       // table.addCell(celln);
				        ...
				        PdfPCell serCell = new PdfPCell(new Phrase(new Phrase(Convert.toString(purchaseOrder.getTxtDiscount()),font)));
				        ...
				        PdfPCell disCell =new PdfPCell(new Phrase(Convert.toString(purchaseOrder.getTxtDisTotal()),font));
				        ...
				        PdfPCell gtCell =new PdfPCell(new Phrase(Convert.toString(purchaseOrder.getTxtAmtPayble()),font));
			...
			ordTaxList.addAll(purchaseOrder.getTaxList());		
			...
			ordLinkedTaxList.addAll(purchaseOrder.getLinkedTaxList());	
		      ...
		      //  celln13.setBorderWidthBottom(0.5f);
		       ...
		       doc.add(tablel);
						...
						tablePN.setSpacingBefore(10);
							...
							cellPS.setPhrase(new Phrase(purchaseOrder.getTxtPubNotes(),font11));
							cellPS.setBorder(Rectangle.NO_BORDER);
							tablePN.addCell(cellPS);
			...
			estTaxList.addAll(purchaseOrder.getTaxList());		
			...
			estLinkedTaxList.addAll(purchaseOrder.getLinkedTaxList());	
	       ...
	       // table.addCell(new Phrase());
	        ...
	        String rd=Convert.toString(purchaseOrder.getRadio());
	        if(rd.equals("per")){
		        PdfPCell vtCell=new PdfPCell(new Phrase("@"+purchaseOrder.getTxtDiscount() +"%",font));			       
		        vtCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		        table.addCell(vtCell);
	        }
	        else
	        {
	        	PdfPCell vtCell=new PdfPCell(new Phrase(Convert.toString(purchaseOrder.getTxtDiscount()),font));			       
		        vtCell.setHorizontalAlignment(Element.ALIGN_RIGHT);
		        table.addCell(vtCell);
	        }
