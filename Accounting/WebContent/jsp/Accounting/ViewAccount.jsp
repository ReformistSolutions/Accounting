 ...
 -->							
          <a href="accounting.do" class="btn btn-primary btn-large"><i class="fa fa-reply"></i> Back</a>
			...
			<c:if test="${message==1}">
					...
					<br>
				<form:form action="" cssClass="form-inline" modelAttribute="viewStaticAccount" name="frmNewAccount">
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div>  
                            	<label>${viewStaticAccount.txtNewAccNo}</label>
                            </div><br>                		
                   		    <div>  
                            	<label>${viewStaticAccount.txtAccountName}</label>
                            </div><br>
                            <div>                            
                                <label>${viewStaticAccount.txtAccountGroup}</label>                            	
                            </div><br>
                            <div>                            
                            	<label>${viewStaticAccount.txtOpeningBalance}</label>                              	                        	
                            </div><br>                            
                             
                            <div><center>
                                <input type="button" value="Print" name="btn" class="btn btn-primary" onclick="urlSubmit('accountPDF.do?accountID=${viewStaticAccount.txtNewAccNo}')">								
