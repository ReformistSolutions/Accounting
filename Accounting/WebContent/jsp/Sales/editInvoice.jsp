...
{  
	...
	var taxTyp = document.getElementById("productList[0].taxType").value;
	 if(document.frmsalesinvoice.txtInvID.value=="")
    {
      alert("Invoice order Number Should not be Empty...");
      document.frmsalesinvoice.txtInvID.focus();
      return false;
    }
     else if(document.frmsalesinvoice.txtCName.value=="0")
    {
      alert("Customer Name should not be blank");
      document.frmsalesinvoice.txtCName.focus();
      return false;
    }     
     else if(document.frmsalesinvoice.txtDate.value=="")
     {
       alert("Date field should not be blank");
       document.frmsalesinvoice.txtDate.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtDueDate.value=="")
     {
       alert(" Due Date field should not be blank");
       document.frmsalesinvoice.txtDueDate.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtBillAddr.value=="")
     {
       alert("Bill To Address field should not be blank");
       document.frmsalesinvoice.txtBillAddr.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtShipAddr.value=="")
     {
       alert("ship To Address field should not be blank");
       document.frmsalesinvoice.txtShipAddr.focus();
       return false;
     }
     else if(srno=="")
     {
     ...
     else if(document.frmsalesinvoice.txtCPONo.value=="")
     {
       alert("Customer Po No should not be blank");
       document.frmsalesinvoice.txtCPONo.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtTransCost.value=="")
     {
       alert("Charges field should not be blank");
       document.frmsalesinvoice.txtTransCost.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtpubNotes.value=="")
     {
       alert("Public notes should not be blank");
       document.frmsalesinvoice.txtpubNotes.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtpvtNotes.value=="")
     {
       alert("Private notes should not be blank");
       document.frmsalesinvoice.txtpvtNotes.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtsubtotal.value=="")
     {
       alert("Sub Total field should not be blank");
       document.frmsalesinvoice.txtsubtotal.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtVat.value=="")
     {
       alert("Vat field should not be blank");
       document.frmsalesinvoice.txtVat.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtSerTax.value=="")
     {
       alert("Service tax field should not be blank");
       document.frmsalesinvoice.txtSerTax.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtES.value=="")
     {
       alert(" Education Service tax field should not be blank");
       document.frmsalesinvoice.txtES.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtSEC.value=="")
     {
       alert("Secondary education Service tax field should not be blank");
       document.frmsalesinvoice.txtSEC.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtdiscount.value=="")
     {
       alert("Discount field should not be blank");
       document.frmsalesinvoice.txtdiscount.focus();
       return false;
     }
     else if(document.frmsalesinvoice.txtGrandTotal.value=="")
     {
       alert("Discount field should not be blank");
       document.frmsalesinvoice.txtGrandTotal.focus();
       return false;
     }
...
function same(s)
{
	var add=document.frmsalesinvoice.txtBillAddr.value;		 
	if(s.checked)
		{		
		  sAdd=document.frmsalesinvoice.txtShipAddr.value;		
		  document.frmsalesinvoice.txtShipAddr.value=add;		 
		}
	else
	{		
	  document.frmsalesinvoice.txtShipAddr.value= sAdd;	  
	}
}
</script>
	...
	j++;
     ...
     var secondCell = row.insertCell(1);
	   ...
	   {		
	   	...
	   	document.getElementById("txtAmtPayble").value=total+parseFloat(document.getElementById("txtDisTotal").value);
...
function checkQuantity(obj)
{
	...
	var availQty = document.getElementById("showLable"+i).innerHTML;
	var newQty= document.getElementById("productList["+i+"].quantity").value;
	if((parseFloat(availQty))<(parseFloat(newQty)))
		{
			alert("Available Product Quantity is Not Sufficient");	
			document.getElementById("productList["+i+"].quantity").focus();
			return true;
		}
	else
		{
				...
				if(taxRateCnt==0)
					...
					for(var i=1;i<=taxRateCnt;i++)
						...
						if(serLinkedTax != null)
							{
							alert("In Not Null If");
							serLinkedTax.value=lTax.toFixed(2);								
							serLinkedTax.id="linkedTax"+k+""+i;	
							document.getElementById("txtTaxTotal").value=(parseFloat(document.getElementById("txtTaxTotal").value)-parseFloat(document.getElementById("taxList["+k+"].txtPrevTax").value)).tofixed(2);
							document.getElementById("txtTaxTotal").value=(parseFloat(document.getElementById("txtTaxTotal").value)-parseFloat(document.getElementById("taxList["+k+"].txtprevLinkTax").value)).tofixed(2);
		 ...
		 for(var k=1;k<=length;k++)
			 ...
			 var taxType = document.getElementById("taxList["+k+"].taxType");
				...
				if(taxRateCnt==0)
					...
					for(var i=1;i<=taxRateCnt;i++)
						{ 					
							...
							if(serLinkedTax != null)
								{
								alert("2 In Not Null If");
								serLinkedTax.value=lTax.toFixed(2);								
								serLinkedTax.id="linkedTax"+k+""+i;
								var ptax=document.getElementById("taxList["+k+"].txtPrevTax").value;
								var pltax=document.getElementById("taxList["+k+"].txtprevLinkTax").value;
								document.getElementById("txtTaxTotal").value=(parseFloat(document.getElementById("txtTaxTotal").value)-(parseFloat(ptax)+parseFloat(pltax)));
								document.getElementById("taxList["+k+"].txtprevLinkTax").value=(parseFloat(document.getElementById("taxList["+k+"].txtprevLinkTax").value)+parseFloat(lTax)).toFixed(2);
								document.getElementById("txtTaxTotal").value=(parseFloat(document.getElementById("txtTaxTotal").value)+parseFloat(document.getElementById("taxList["+k+"].txtprevLinkTax").value)+parseFloat(taxAmt)).toFixed(2);
								
								}
							else
								{
								alert("2 In Null else");
								document.getElementById("linkedTax"+k+""+i).value=lTax.toFixed(2);	
								var ptax=document.getElementById("taxList["+k+"].txtPrevTax").value;
								var pltax=document.getElementById("taxList["+k+"].txtprevLinkTax").value;
								document.getElementById("txtTaxTotal").value=(parseFloat(document.getElementById("txtTaxTotal").value)-(parseFloat(ptax)+parseFloat(pltax)));
				...
				var finalRound=1-finalroundOfAmt;
				 if(froundOfAmt>50)
					{
						document.getElementById("txtAmtPayble").value=(parseFloat(document.getElementById("txtTransCost").value)+parseFloat(document.getElementById("txtTaxTotal").value)+parseFloat(document.getElementById("txtDisTotal").value)+parseFloat(taxTotalRound)+1);/* -parseFloat(document.getElementById("txtTaxTotal").value); */
						document.getElementById("txtRoundOff").value="+ "+parseFloat(finalRound).toFixed(2);
					}
				else
					{					
						document.getElementById("txtAmtPayble").value= (parseFloat(document.getElementById("txtTransCost").value)+parseFloat(document.getElementById("txtDisTotal").value)+parseFloat(taxTotalRound));/* -parseFloat(document.getElementById("txtTaxTotal").value); */
						document.getElementById("txtRoundOff").value="- "+parseFloat(finalroundOfAmt).toFixed(2);
					} 
				  ...
				  if((currenTax.substring(0,8))==(exTax.substring(0,8)))
					{
				    	 ...
				    	 document.getElementById("taxList["+sr+"].txtprevLinkTax").value="0.0";
				    	 document.getElementById("getTax"+sr).innerHTML="";
				    	 document.getElementById("taxList["+sr+"].taxType").options[1].selected=true;
						 return true;
					}
				else
					{
...
<br>
     <div class="col-md-12">	
		       <div class="panel panel-default">
	            		...
	            		<div class="col-md-10">	            		
			              ...
			              <div class="col-md-2 pull right" >
			             	<div>
			             		<a href="invoice.do" data-toggle="tooltip" data-placement="left" title="Back" class="btn btn-primary btn-large"> Back</a>
			             	</div>   
			             </div>
			      </div>
			      </div>
			   ...
			   <div class="col-md-12">
			   <form:form action="updateInvoice.do" method="post" commandName="salesInvoice" cssClass="form-inline" name="frmsalesinvoice" onsubmit="return validateForm()"  >
		<div class="panel panel-default">
		<div class="panel-body">
		<div class="row first column">
					...
					<div class="col-md-2" style="width:170px;">
							<select name="txtCName" id="txtCName" style="width: 160px;" onchange="retriveAdd(this.value,this.id)" class="form-control">
								<option value="0">--Select Name--</option>
								<option value="${salesInvoice.custId}" selected="selected">${salesInvoice.txtCName}</option>
					...
					<div class="col-md-2">
							<form:input path="txtInvID" cssStyle="width:100px;" readonly="true" cssClass="form-control"></form:input>
					</div>
					<div class="col-md-2" style="width:90px">
							<label>Order&nbsp;Id:</label>
					</div>
					<div class="col-md-2">
							<select name="orderId" id="orderId" style="width: 110px;" class="form-control">
								<option value="0">--Select--</option>
								<option value="${salesInvoice.orderId}" selected="selected">${salesInvoice.orderId}</option>
					...
					<div class="col-md-2">
						<input type="text"  id="date" value="${salesInvoice.txtDate}" style="width:130px;" name="txtDate" class="form-control"></input>
					</div>
					<div class="col-md-2" style="width:120px;">
						<label>Due&nbsp;Date:</label>
				    </div>
						<div class="col-md-2">
							<input type="text" id="ddate" value="${salesInvoice.txtDueDate}" style="width:130px;" name="txtDueDate" class="form-control"></input>
						</div>					
					</div>
<br>
<div class="row">
			<div class="col-md-5">
				...
				<div class="col-md-2">	
					<form:textarea rows="2" cols="25" cssStyle="resize:none;" onkeyup="textAreaAdjust(this)" path="txtBillAddr" cssClass="form-control"></form:textarea>
				</div>
				</div>
			</div>
			<div class="col-md-6">
			<div class="row">
				...
				<div class="col-md-3">						 		      			      				
					<form:textarea rows="2" cols="25" cssStyle="resize:none;" onkeyup="textAreaAdjust(this)" path="txtShipAddr" cssClass="form-control"></form:textarea>
				</div>
			</div> 
		</div>			
		</div>
		...
		<div class="table-responsive">
						<table id="tableID" class="table table-striped">		
								...
								<c:forEach items="${salesInvoice.productList}" var="productList">
								<tr>
									...
									<td>
										<select name="productList[${productList.srNo-1}].itemCode" id="itemCode${productList.srNo-1}" onchange="showDesc(this.value,this.id);disQuantity(this.id);" style="width:120px;" class="form-control" >
											
											<option value="">---Select---</option>	
											<option value="${productList.prodId}" id="${productList.prodId}" style="display: none;"> ${productList.itemCode} </option>											
												<c:forEach items="${invoiceProdList}" var="invoiceProdList">
													<option value="${invoiceProdList.productId }">${invoiceProdList.txtName }</option>
												</c:forEach>
												 <script type="text/javascript">			
									...
									<td><input type="text" name="productList[${productList.srNo-1}].des" id="productList[${productList.srNo-1}].des" value="${productList.des}" style="width:120px;" class="form-control"></td>
									<td><input type="text" name="unit${productList.srNo-1}" id="unit${productList.srNo-1}" class="form-control" readonly="readonly" value="${productList.unit}" style="width:80px;"></td>
									...
									<td><input type="text" name="productList[${productList.srNo-1}].quantity" id="productList[${productList.srNo-1}].quantity" value="${productList.quantity}" onkeypress="return isNumberKey(this)" onblur="calSubTotal(this.id);checkQuantity(this.id);" class="form-control" style="width:80px;text-align: right;"></td>
					...
					<div class="col-md-6 pull right">
						<div class="row">
							...
							<div class="col-md-4">
								...
								<input type="hidden" name="hideTransCost" class="form-control" id="hideTransCost" value="${salesInvoice.txtTransCost}" style="width:180px;">
							</div>
						</div>
					</div>
				</div><br>		
					...
					<div class="panel-body">
                        ...
                        <div class="tab-content" style="padding: 1;">
                        	<div class="tab-pane fade in active" id="home">
                        		<p></p>
                        		<form:textarea path="txtpubNotes" cssClass="form-control" cols="25" rows="5"/>
                        	</div>
                        	<div class="tab-pane fade" id="profile">
                        		<p></p> 
                        		<form:textarea path="txtpvtNotes" cssClass="form-control" cols="25	" rows="5"/>
                        	</div>
                        </div>
					</div>
				</div>
		...
		<div class="col-md-7">
				...
				<div class="col-md-12">
					...
					<div class="col-md-5">
						<input type="text" name="txtSubTotal" readonly="readonly" id="txtSubTotal" class="form-control" value="${ salesInvoice.txtSubTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div> 
				<c:choose>
					<c:when test="${salesInvoice.radio != 'null'}">					
				...
				<div class="col-md-12">
					<div class="col-md-3">
						<div class="row">
						<c:choose>
						<c:when test="${salesInvoice.radio=='per'}">
					...
					<div class="col-md-5">
						<input type="text" name="txtDiscount" id="txtDiscount" value="${ salesInvoice.txtDiscount}" class="form-control" onkeypress="return isNumberKey(this)" onblur="calDis();"></input>
					</div>					
					<br>
				</div>				
				</div>
			...
			<div style="height: 5px;"></div>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="text" name="txtDisTotal" readonly="readonly" id="txtDisTotal" class="form-control" value="${ salesInvoice.txtDisTotal}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>	
				<c:choose>
...
<tbody>
<%int cnt=1; %>
<c:forEach items="${salesInvoice.taxList}" var="taxDetailsList">
<tr>
<td>
...
<div id="linkedDiv">
<%int count=1; %>
	<c:forEach items="${salesInvoice.linkedTaxList}" var="linkedTaxList">
		<div>
...
<tr><td colspan="5" id="getTax1"></td></tr>
				...
				<div class="col-md-3"></div>
					...
					<div class="col-md-5">
						<input type="hidden" name="txtTaxTotal" value="${salesInvoice.txtTaxTotal}" id="txtTaxTotal" class="form-control"/>
						<input type="text" name="txtRoundOff" value="${salesInvoice.txtRoundOff}" readonly="readonly" id="txtRoundOff" class="form-control" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
				<div style="height: 5px;"></div>
				...
				<div class="col-md-2"></div>
					...
					<div class="col-md-4">
						...
						<input type="text" name="txtAmtPayble" readonly="readonly" id="txtAmtPayble" class="form-control" value="${salesInvoice.txtAmtPayble}" onkeypress="return isNumberKey(this)"></input>
					</div>
				</div>
				</div>
							...
							<div class="col-md-12">
									...
									<a href="invoice.do" class="btn btn-primary btn-large" data-toggle="tooltip" data-placement="top" title="Cancel"> Cancel</a>									
							</div>
			</div>	
...
<c:if test="${message==0}">                     
<h4 class="msg-error">
Invoice Not Updated Succesfully.
</h4> 
</c:if>		
