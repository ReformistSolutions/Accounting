...
function showDetails()
{
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
					document.getElementById("showWarehouse").innerHTML = xmlhttp.responseText;
				}
			}
		}
			xmlhttp.open("GET", "retriveWarehouseDetails.do?warehouseId=" + warehouseId , true);
		xmlhttp.send();
	}
</script>
</head>	
...
<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							<div class="col-md-8">
								<ul class="breadcrumb">
									<li class="active"><small>Warehouse wise Stock</small>
								</ul>
							</div>
							<div class="col-md-3">
