...
<form:form action="updateGroupAccount.do" cssClass="form-inline" name="frmCreateAccount" modelAttribute="editGrpAccount">
	         <div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="col-sm-3">
							<div>  
                            	<form:input path="txtAccGrpNo" readonly="true" cssClass="form-control"></form:input>
                            </div><br>                 		
                   		<div>  
