	...
	<div id="container">
						...
						<ul class="breadcrumb">
							<li class="active"><small><i class="fa fa-2x fa-table"></i></small>&nbsp;Compose<small>&nbsp;Mail</small>
			             	...
			             	<div class="col-md-2">
			             	<button onclick="goBack()" data-toggle="tooltip" data-placement="left" title="Back" class="btn btn-primary btn-large"><i class="fa fa-reply"></i> Back</button>
			...
			<form:form action="purchaseSendMail.do" cssClass="form-inline" modelAttribute="composeMail" name="frmSendMail" onsubmit="return validateForm()">
		            <div class="col-md-12">
						<div class="panel">
							<div class="panel-body">
								<div class="row">
							...
							<div class="row">
								<div class="col-md-10">
									<div class="row">
										...
										<div class="col-md-8">
											<input type="text" name="subject" id="subject" value="${vendInfo.subject}" style="width:350px;" class="form-control">
											<input type="hidden" name="custId" value="${vendInfo.txtCustID}">
											<input type="hidden" name="id" value="${vendInfo.id}">
										</div>
									</div>
								</div>								
							...
							<div class="row">
								<div class="col-md-10">
									<div class="row">
										...
										<div class="col-md-8">
											<textarea name="body" id="body" rows="8" cols="52" class="form-control">Hello  ${vendInfo.txtCustName}<%="\n"%><%="\n"%>${vendInfo.bodyPart}<%="\n"%><%="\n"%>Kind Regards<%="\n"%> ${vendInfo.regards}</textarea></textarea>
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-10">
									<div class="row">
										...
										<input type="hidden" name="attachment" id="attachment" value="${vendInfo.attachment}" readonly="readonly" style="width: 200px;border: none;" class="form-control">
										<label><img src="<c:url value="/resources/images/PDF-icon.png" />" height="20" width="20"></img>&nbsp;&nbsp;${vendInfo.attachment}</label>
										<!-- <link rel="icon" href="<c:url value="/resources/images/favicon.ico" />" type="image/icon"> -->
										</div>
									</div>
								</div>
