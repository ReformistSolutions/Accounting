...
public class ReceiveAgainstProdPDF extends AbstractPdfView
{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		ReceiveAgainstProduct receiveAgainstProd = (ReceiveAgainstProduct) model.get("viewreceiveAgainProd");
		...
		cell3.setPhrase(new Phrase("RECEIVE AGAINST PRODUCT",font1));
		...
		f1.setColor(BaseColor.BLACK);
		    ...
		    celld1 = new PdfPCell(new Phrase("Voucher No      :"+"   "+receiveAgainstProd.getTxtVNo(),f1));
		    celld1.setColspan(3);	    
		    tabled.addCell(celld1);
		    
		    celld2 = new PdfPCell(new Phrase("Date  :"+"   "+receiveAgainstProd.getDate(),f1));
		    celld2.setColspan(3);
		    ...
		    celld11 = new PdfPCell(new Phrase("Purchase ID :"+"       "+receiveAgainstProd.getTxtpurNo(),f1));
			...
			List<ReceiveAgainstProductDetails> receiveAgainstProdDetails=new ArrayList<ReceiveAgainstProductDetails>();		
			receiveAgainstProdDetails.addAll(receiveAgainstProd.getReceiveAgainstProductList());
			for(ReceiveAgainstProductDetails productWasteList : receiveAgainstProdDetails)
			{
			{
				
				PdfPCell cell20 = new PdfPCell(); 
				cell20.setPhrase(new Phrase(Convert.toString(productWasteList.getTxtSrNo1())));
				cell20.setHorizontalAlignment(Element.ALIGN_RIGHT);
				tableDetails.addCell(cell20);
				
				PdfPCell cellit = new PdfPCell();
				cellit.setPhrase(new Phrase(productWasteList.getTxtItem1(), font));
				tableDetails.addCell(cellit);	
			
				PdfPCell cell21 = new PdfPCell();
				cell21.setPhrase(new Phrase(Convert.toString(productWasteList.getTxtQuant1()), font));
	...
	cell.setPhrase(new Phrase(receiveAgainstProd.getTxtDetails(),font));
	cell.setBorder(Rectangle.NO_BORDER);
