...
public class ReceiveforSales {

	private String txtVNo;
	private String date;
	private String wearehouseID;
	private String selectWarehouse;
	private String selectSalesorderid;
	public String getSelectSalesorderid() {
		return selectSalesorderid;
	}
	public void setSelectSalesorderid(String selectSalesorderid) {
		this.selectSalesorderid = selectSalesorderid;
	}
