...
public class EnquiryPdf extends AbstractPdfView{
	...
	public void buildPdfDocument(Map<String, Object> model,
		...
		PdfWriter.getInstance(doc, new FileOutputStream(System.getProperty("user.dir")+"/Sales Enquiry.pdf")); 
	
	        doc.open();
	
		Enquiry saleEnquiry=(Enquiry) model.get("salesEnquiry");
		...
		tableHD.setSpacingBefore(10);
			...
			//cell3.setPadding(5);
			cell3.setPhrase(new Phrase("SALES  ENQUIRY",font1));			
			//cell3.setColspan(5);
    ...
    celld1 = new PdfPCell(new Phrase("Customer Name      : "+"   "+saleEnquiry.getTxtCutName(),font));
    celld1.setColspan(3);
    tabled.addCell(celld1);    
  
    
    celld4 = new PdfPCell(new Phrase("Party VAT TIN No : "+"   "+saleEnquiry.getCustVatNo(),font));
    celld4.setColspan(3);
    ...
    celld12 = new PdfPCell(new Phrase("Enquiry No    : "+"      "+saleEnquiry.getTxtEnqId(),font));
    celld12.setColspan(3);
    tabledd.addCell(celld12);
     
  
    celld13 = new PdfPCell(new Phrase("Date                : "+"      "+saleEnquiry.getTxtDate(),font));
	...
	doc.add(tableBlf1);
		...
		enqDetails.addAll(saleEnquiry.getEnquiryDetails());
		for(EnquiryDetails productList : enqDetails)
		{
			...
			cellunit.setPhrase(new Phrase(productList.getMunit(), font));
		 ...
		 PdfPTable tablel = new PdfPTable(3);
	      ...
	      PdfPTable tablePN = new PdfPTable(4);
			...
			tablePN.setSpacingBefore(10);
				...
				cellPS.setPhrase(new Phrase("\n"+saleEnquiry.getTxtPubNotes(),font));
				cellPS.setBorder(Rectangle.NO_BORDER);
				tablePN.addCell(cellPS);
			...
			//Font fnt=new Font(FontFamily.TIMES_ROMAN,12,Font.BOLD,new GrayColor(100f));
			ColumnText.showTextAligned(writer.getDirectContentUnder(),Element.ALIGN_BOTTOM,new Phrase(cid.getWebsite(),font), 300f, 500f,writer.getPageNumber()% 2 == 1 ? 45 : -45);
		...
		doc.setPageCount(1);
		doc.addHeader("fdzhgdfh","dfgsdfgh");*/
