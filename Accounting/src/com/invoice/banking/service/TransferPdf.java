...
public class TransferPdf extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model,
		...
		Transfer transfer=(Transfer) model.get("transfers");
...
CompanyDetails cid=(CompanyDetails) model.get("compInfo");
		...
		tableHD.setSpacingBefore(10);
			...
			cell3.setPhrase(new Phrase("TRANSFER RECEIPT",font1));			
	...
	cell0.setPadding(5);
		...
		cell.setPhrase(new Phrase(transfer.getTxttransVchrNo(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tableFR.addCell(cell);
		...
		cell.setPhrase(new Phrase(transfer.getTxttransdate(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tableSR.addCell(cell);	
		...
		cell.setPhrase(new Phrase(transfer.getTxttransFrmAccnt(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN.addCell(cell);
		...
		cell.setPhrase(new Phrase(transfer.getTxttransToAccnt(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN1.addCell(cell);
		...
		cell.setPhrase(new Phrase(transfer.getTxttransTransType(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN2.addCell(cell);
		...
		cell.setPhrase(new Phrase(Convert.toString(transfer.getTxttransAmount())));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN3.addCell(cell);
		...
		cell.setPhrase(new Phrase(transfer.getTxttransDesc(),font));
		cell.setBorder(Rectangle.NO_BORDER);
		cell.setMinimumHeight(40f);
		tablePN4.addCell(cell);
