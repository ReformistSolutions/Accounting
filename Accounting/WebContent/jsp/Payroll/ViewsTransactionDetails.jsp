...
<form:form action="" method="post" cssClass="form-inline" commandName="withdraw">
<br>
<div class="col-md-12">
						<div class="panel">
             ...
             <button type="button" class="btn btn-primary" value=""><small><i class="fa fa-building-o"></i></small> Bank Reconcilition</button>
			             	</div>
		             	</div>
		             	</div>
		             </div>	<br><br><br><br>
