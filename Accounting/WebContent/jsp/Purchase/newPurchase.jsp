...
<%@ include file="../header.jsp" %>
	...
	<input type="hidden" name="hide" id="hidden" />
		...
		<div class="col-md-12">
						...
						<div class="col-md-10">
						<ul class="breadcrumb">
							<li class="active"><small><i class="fa fa-2x fa-table"></i></small>&nbsp;Purchase<small>&nbsp;</small>
		             	</ul>
		             	</div>
			             	<div class="col-md-2">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="row">
					...
					<div class="col-md-3">
					<input type="text" name="txtPurchaseNo" class="form-control" readonly="readonly" style="width: 100px;" value="${purchases.txtPurchaseNo}">
					</div>
				</div>		 
			</div>
			...
			<table class="table table-striped" id="tableID">
				...
				<%-- <c:forEach items="${purchaseOrder.productList}" var="pList"> --%>
					<tr>
						...
						<td>
            						<select name="productList[0].itemCode" id="itemCode0" class="form-control" style="width:100px;" onchange="showDesc(this.value,this.id);showUnitPrice(this.value,this.id);">
