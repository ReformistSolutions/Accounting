	         ...
	         <div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="col-sm-3">
							<div>  
                            	<label>${viewGrpAccount.txtAccGrpNo}</label>
                            </div><br>                		
                   		<div>  
                            ...
                            <div><center>
                                <input type="button" value="Print" name="btn" class="btn btn-primary" onclick="urlSubmit('groupAccountPDF.do?groupID=${viewGrpAccount.txtAccGrpNo}')">           								
